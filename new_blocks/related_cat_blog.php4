<div class="block hidden-xs">
	<div class="header">
		<h3><span><?=$view_related_cat_blog?></span></h3>
	</div>
	<div class="content post-block">
		...
		<?if($cat_id==0||get_result("select count(id) from new_modules_cat where id=$cat_id and type=10",$coms_conect)==0)
			...
			$queryw1="select  a.la,a.title,a.id from new_blog a ,new_modules_catogory b  
			where  
			site='$site' and la='$la' and status=1 and b.type=10 and a.id=b.page_id  and publish_date<=now()
