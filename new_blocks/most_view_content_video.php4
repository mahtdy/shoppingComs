<div class="block hidden-xs">
	<div class="header">
		<h3><span><?=$view_visit_conten_video?></span></h3>
	</div>
	<div class="content video-block">
		<ul>
			<?$query1="select  a.name,a.title,a.la ,a.id,b.adress from new_content a ,new_file_path b 
			where b.name='content_video'  and site='$site' and la='$la' and a.status=1 and b.type=11 and a.id=b.id  and publish_date<=now()
