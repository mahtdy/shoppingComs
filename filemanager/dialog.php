...
<div class="uploader">
	<div class="text-center">
		<button class="btn btn-inverse close-uploader"> <?php echo trans('Return_Files_List')?> <i class="icon-backward icon-white"></i></button>
	</div>
...
<div class="navbar navbar-fixed-top">
	<div class="navbar-inner">
		...
		<div class="filters">
			<div class="row-fluid">
			<div class="span6 half" style="direction:rtl;text-align:left">
...
<!-- header div end -->
	...
	<!-- breadcrumb div end -->
	<div class="row-fluid ff-container" style="text-align:right">  
	<div class="span12">
