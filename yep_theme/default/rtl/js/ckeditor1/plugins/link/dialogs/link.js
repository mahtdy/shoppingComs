...
(function ()
{
	...
	CKEDITOR.dialog.add("link", function (c)
	{
		...
		return {
			title: b.title,
			minWidth: "moono-lisa" == (CKEDITOR.skinName || c.config.skin) ? 320 : 250,
			minHeight: 220,
			contents: [{
				id: "info",
				label: b.info,
				...
				elements: [{
					...
					children: [{
						...
						children: [{
							id: "protocol",
							type: "select",
							style: g.protocol == "Protocol" ? "" : "text-align:left;margin-left:-10px",
							label: g.protocol,
							"default": "http://",
							width: '100%',
							items: [
						...
						children: [
							{
								...
								children: [
									...
									},
									{
										...
										onClick: function ()
										{
											var id = CKEDITOR.dialog.getCurrent().getContentElement("info", "url").getInputElement().getId();
											OpenFileManager(id, "Single", "all", null, $("#" + id).val());
										}
									},
									{
										type: 'button',
										...
										{
											alert("SelectPage");
											//OpenLinkManager(CKEDITOR.dialog.getCurrent().getContentElement("info", "url").getInputElement().getId());
										}
									},
									{
										type: 'html',
