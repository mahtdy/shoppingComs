...
(function ()
{
	var u = function (d, k)
	{
		...
		return {
			...
			minWidth: "moono-lisa" == (CKEDITOR.skinName || d.config.skin) ? 320 : 320,
			minHeight: 300,
			onShow: function ()
			{
				...
				elements: [{
					...
					children: [{
						...
						,
						{
							type: 'button',
							id: 'SelectImage',
							label: d.lang.image.selectImage,
							style: 'margin-top:25px',
							width: "100%",
							onClick: function ()
							{
								var id = CKEDITOR.dialog.getCurrent().getContentElement("info", "txtUrl").getInputElement().getId();
								OpenFileManager(id, "Single", "Image", null, $("#" + id).val());
							}
						}]
					}]
				},
