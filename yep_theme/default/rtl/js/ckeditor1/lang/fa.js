...
CKEDITOR.lang['fa'] = {
	...
	"common": {
		...
		"invalidInlineStyle": "عدد تعیین شده برای استایل درون خطی -Inline Style- باید دارای یک یا چند چندتایی با شکلی شبیه \"name : value\" که باید با یک \";\" از هم جدا شوند.",
	...
	"div": {
		...
		"cssClassInputLabel": "کلاس استایل",
		"edit": "ویرایش Div",
		"inlineStyleInputLabel": "استایل درون خطی(Inline Style)",
	...
	"find": {
		...
		"findWhat": "عبارت خود را بنویسید: ",
		"matchCase": "برابری در بزرگی و کوچکی حروف",
		"matchCyclic": "برابری با چرخه",
		"matchWord": "برابری با واژهٴ کامل",
		"notFoundMsg": "متن موردنظر یافت نشد.",
		"replace": "جایگزینی",
		"replaceAll": "جایگزینی همهٴ یافته ها",
		"replaceSuccessMsg": "%1 رخداد جایگزین شد.",
		"replaceWith": "جایگزینی با عبارت:",
	...
	"flash": {
		...
		"validateSrc": "لطفا URL لینک را بنویسید",
	...
	"font": {
		"fontSize": {
			"label": "اندازه",
			"voiceLabel": "اندازه فونت",
			"panelTitle": "اندازه فونت"
		},
		"label": "فونت",
		"panelTitle": "نام فونت",
		"voiceLabel": "فونت"
	...
	"link": {
		...
		"noUrl": "لطفا URL لینک را بنویسید",
	...
	"liststyle": {
		"bulletedTitle": "ویژگی های فهرست نقطه ای",
		"circle": "دایره",
		...
		"none": "هیچ",
		"notset": "<تنظیم نشده>",
		"numberedTitle": "ویژگی های فهرست شماره دار",
		"square": "چهارگوش",
		"start": "شروع",
		"type": "نوع",
	...
	"specialchar": {
		"options": "کارکترهای ویژه",
		"title": "انتخاب کاراکترهای ویژه",
		"toolbar": "گنجاندن کارکترهای ویژه"
	},
	"scayt": {
		"btn_about": "درباره SCAYT",
		"btn_dictionaries": "دیکشنری ها",
		"btn_disable": "غیرفعالسازی SCAYT",
		"btn_enable": "فعالسازی SCAYT",
		"btn_langs": "زبان ها",
		"btn_options": "گزینه ها",
		"text_title": "بررسی املای تایپ شما"
	},
	"stylescombo": {
		"label": "کلاس استایل",
		"panelTitle": "استایل های قالب بندی",
		"panelTitle1": "... بلوک ...",
		"panelTitle2": "... اینلاین ...",
		"panelTitle3": "استایل های شیء"
	},
	"fields":
	{
		"label": "فیلد ها",
		"fieldsPublic": "فیلد های عمومی",
	},
	"table": {
		"border": "خط حاشیه",
		"caption": "عنوان",
