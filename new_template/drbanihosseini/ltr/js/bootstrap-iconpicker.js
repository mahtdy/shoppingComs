...
;(function($){ "use strict";
    ...
    Iconpicker.ICONSET = {
        ...
        pgicon: $.iconset_pgicon || Iconpicker.ICONSET_EMPTY,
		yepcoicon3: $.iconset_yepcoicon3 || Iconpicker.ICONSET_EMPTY,
    ...
    Iconpicker.DEFAULTS = {
        ...
        arrowNextIconClass: 'glyphicon glyphicon-arrow-left',
        arrowPrevIconClass: 'glyphicon glyphicon-arrow-right',
        cols: 6,
        icon: '',
        iconset: 'glyphicon',
        labelHeader: '{0} / {1}',
        labelFooter: '{0} - {1} از {2}',
        placement: 'bottom',
        rows: 4,
        search: true,
        searchText: 'جستجو',
