        ...
        <div class="tab-pane <? if ($edit_id == "") echo 'active' ?>" id="" style="background-color: #EFF3F8;">
            ...
            <table cellpadding="0" cellspacing="0" border="0" class="datatable table table-striped table-bordered"
                ...
                <tr>
                    ...
                    <th class="center">حداکثر در سبد خرید</th>
                ...
                // $str_cat
                $sql1 = "select count(a)as cnt from (SELECT count(a.id) as a from new_product_brand a  where la='$la' )q";
                //                  echo $sql1; exit;
                ...
                while ($RS1 = $result->fetch_assoc()) {
                    ...
                    <tr>
                        ...
                        <td>   6 </td>
                        <td>  7  </td>
                        <td><input type="text" id="price_pro" name="price_pro" value=""><label for="price_pro">=</label>  </td>
                        <td>  9  </td>
                        <td>  10  </td>
