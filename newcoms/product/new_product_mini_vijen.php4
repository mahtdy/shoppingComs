<div class="tab-pane fade" id="vijen">
...
//                            echo 'idval='.$id_val;
                    ...
                    $j = 0;
                    echo "<div class='col-md-3 form-group'><select name='cat_id_vijen' id='cat_id_vijen'  data-id='" . $RS['id'] . "' class='form-control' disabled><option  >دسته بندی اصلی انتخاب نشده است</option> ";
                    ...
                    echo "</select></div>";
                    ?>
                    <div class="col-md-12 form-group" id="result_property_vijen" ></div>
                    ...
                    if ($edit_id > '') { ?>
                        <script>
                            ...
                            if(catasl!=0) {
                                ...
                                // var catasl = $('#cat_asli').val();
                                // alert('asl=' + catasl+'=='+edit_id);
                                // a=catasl;
                                $('#cat_id_vijen').val(catasl);
                                // alert('a='+a);
                                $.ajax({
                                    type: 'POST',
                                    url: 'New_ajax_product.php',
                                    data: "action=product_property_cat_vijen&id=" + catasl + "&edit_id=" + edit_id,
                                    success: function (result) {
                                        $("#result_property_vijen").html(result);
                                    }
                                });
                            }
                            ...
                            // $('#cat_id_vijen').change(function () {
                            //     a = $(this).find(':selected').attr('value');
                            //     // alert('a2='+a);
                            //     $.ajax({
                            //         type: 'POST',
                            //         url: 'New_ajax_product.php',
                            //         data: "action=product_property_cat_vijen&id=" + a + "&edit_id=" + edit_id,
                            //         success: function (result) {
                            //             $("#result_property_vijen").html(result);
                            //         }
                            //     });
                        ...
                        <script>
                            ...
                            $('#cat_asli').change(function () {
                                ...
                                $.ajax({
                                    type: 'POST',
                                    url: 'New_ajax_product.php',
                                    data: "action=product_property_cat_vijen&id=" + catasl ,
                                    success: function (result) {
                                        $("#result_property_vijen").html(result);
                                    }
                                });
                            ...
                            //         type: 'POST',
                            //         url: 'New_ajax_product.php',
                            //         data: "action=product_property_cat_vijen&id=" + a,
                            //         success: function (result) {
                            //             $("#result_property_vijen").html(result);
                            //         }
                            //     });
