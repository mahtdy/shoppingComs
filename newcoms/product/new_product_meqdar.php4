...
$vahed=injection_replace($_POST['vahed']);
...
if($vahed>""&&$edit_mode==0){

//    check_token( $_REQUEST[ 'user_token' ], $_SESSION[ 'session_token' ], '/coms' );

    $sql="SELECT id FROM new_product_meqdarvazn ORDER BY id DESC LIMIT 1";
...
//	values (1,'$meta_keyword','$meta_desciption','$onvan',$id,'$modual_type',NOW(),$manager_id,'$custom_ip','$manage_lang','$seo_title')";
    ...
    $query1="insert into new_product_meqdarvazn(vahed,status,rang) values ('$vahed',1,$id)";
//echo $query1;
...
//    $query1="update new_modules_cat set seo_title='$seo_title', meta_keyword='$meta_keyword',meta_desciption='$meta_desciption',name='$onvan',edit_date=NOW(),edit_user_id='$manager_id',ip='$custom_ip' where id='$edit_mode'";
    $query1="update new_product_meqdarvazn set vahed='$vahed' where id='$edit_mode'";
    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="alert alert-warning"><span class="glyphicon glyphicon-warning-sign"></span> آيا از حذف واحد زير اطمينان داريد؟</div>
...
<div class="tabbable">
    ...
    <ul class="nav nav-tabs" style="display:none;">
        ...
        <li class="active"><a href="#tab3" data-toggle="tab"><i class="green ace-icon fa fa-home bigger-120"></i>واحد </a></li>
...
<!---->
            <input name='cat_url' id='url_id' value='<?=$url?>' type="hidden">
<!---->
                            ...
                            <div class="panel-body">
                                ...
                                <div class="row-fluid">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <label class="col-md-2 control-label" for="group_name">عنوان واحد</label>

                                        <div class="form-group col-md-5">

                                            <input type="text" name="vahed" id="vahed" value="" class="form-control" >
        ...
        <div class="col-md-12">
            ...
            <div class="panel panel-primary">
                ...
                <div class="panel-heading">
                    ...
                    <h3 class="panel-title">مرتب سازی واحدها</h3>
...
//                    $sql = "SELECT * FROM new_modules_cat a,new_cat_permission b  WHERE    b.permission=1 and a.id=b.menu_id and a.parent_id='0' and b.group_id={$_SESSION["manager_group_id"]} and a.type='$modual_type' and a.la='$manage_lang' ORDER BY a.rang";
                    $sql = "SELECT * FROM new_product_meqdarvazn  ORDER BY rang";
                    ...
                    while($row = $result->fetch_assoc()) {
                        ...
                        echo "<div class='dd-handle'><a target='_blank' href="."/$modul_name/$manage_lang/category/$name/1"."> {$row['vahed']}</a>";

                        echo '	<div class="pull-right action-buttons">';

//                        if ($modual_type==444)echo '<a href="newcoms.php?yep=new_product_cat_cat&catid='.$row['id'].'&catof='.'0'.'" class="btn btn-info" role="button">'.'دسته بندی فیلدها'.'</a><a href="newcoms.php?yep=new_product_cat_cat&catid='.$row['id'].'&catof='.'1'.'" class="btn " role="button">'.'فیلترینگ ویژگی ها'.'</a>';
...
//                        if(menu_has_child($id,$coms_conect)==0&&!get_result("select count(id) from new_product_meqdarvazn where id=$id",$coms_conect)&&$_SESSION["can_delete"]==1){
...
//                        show_madules_cat($row['id'],$site_id,$manage_lang, $modual_type ,$coms_conect,$modul_name);
    ...
    <script src="../../ajax_js/page_vahed.js"></script>
