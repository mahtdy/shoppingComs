...
if($_POST['send_flag']==1){
	...
	#####پیش فرض ناوبری	 
	$ads_nav_picture=injection_replace_pic($_POST["ads_nav_picture"]);
	$query11="SELECT id from new_default_navbar where name='ads_nav_picture' and la='$la' and site='$site'";
	//echo $query11.'<br>';
	$result11 = $coms_conect->query($query11);
	$row11 = mysqli_num_rows($result11);
	if ($row11> 0) {
	   $query="update new_default_navbar set address='$ads_nav_picture' where name='ads_nav_picture'  and la='$la'  and site='$site'"; 
	   $coms_conect->query($query);
	}else{
     	$query="insert into new_default_navbar(site,address,la,name)values('$site','$ads_nav_picture','$la','ads_nav_picture')";
     	$coms_conect->query($query);
	}
	
####صفحه اصلي
	$ads_have_ads=injection_replace_pic($_POST["ads_have_ads"]);
	if($ads_have_ads!=1) $ads_have_ads=0;
	insert_ads_templdate($site,$la,$ads_have_ads,'ads_have_ads',$coms_conect);
 	$query1="delete from new_tem_setting where name='ads_have_ads'"; 
	...
	for($i=1;$i<=$ads_count;$i++){ 
		...
		insert_news_templdate($site,$header_pic,$la,'',$title_ads,$header_link,'',"ads_have_ads",'',$coms_conect);
	} 
####فایل نمایش
	$ads_show_have_ads=injection_replace_pic($_POST["ads_show_have_ads"]);
	if($ads_show_have_ads!=1) $ads_show_have_ads=0;
	insert_ads_templdate($site,$la,$ads_show_have_ads,'ads_show_have_ads',$coms_conect);
 	$query1="delete from new_tem_setting where name='ads_show_have_ads'"; 
	$coms_conect->query($query1);
	for($i=1;$i<=$ads_show_count;$i++){ 
		...
		insert_news_templdate($site,$header_show_pic,$la,'',$title_show_ads,$header_show_link,'',"ads_show_have_ads",'',$coms_conect);
	}	
#######دسته بندي
	$ads_cat_have_ads=injection_replace_pic($_POST["ads_cat_have_ads"]);
	if($ads_cat_have_ads!=1) $ads_cat_have_ads=0;
	insert_ads_templdate($site,$la,$ads_cat_have_ads,'ads_cat_have_ads',$coms_conect);
	$query1="delete from new_tem_setting where name='ads_cat_have_ads'"; 
	$coms_conect->query($query1);
	for($i=1;$i<=$ads_cat_count;$i++){	
		...
		insert_news_templdate($site,$image_cat_ads,$la,'',$title_cat_ads,$link_cat_ads,'',"ads_cat_have_ads",'',$coms_conect);
	}

######جستجو	
	$ads_sesrch_have_ads=injection_replace_pic($_POST["ads_sesrch_have_ads"]);
	if($ads_sesrch_have_ads!=1) $ads_sesrch_have_ads=0;
	insert_ads_templdate($site,$la,$ads_sesrch_have_ads,'ads_sesrch_have_ads',$coms_conect);
	$query1="delete from new_tem_setting where name='ads_sesrch_have_ads'"; 
	$coms_conect->query($query1);
	for($i=1;$i<=$ads_search_count;$i++){ 
		...
		insert_news_templdate($site,$image_search_ads,$la,'',$title_search_ads,$link_search_ads,'',"ads_sesrch_have_ads",'',$coms_conect);
	}
}
...
<div class="tabbable">
	...
	<div class="secfhead">
<!-- #section:ads/ads_setting.head -->
<div class="sectitle">
<div class="icon"><span class="flaticon-file23" style=""></span></div>
<div class="title"><p class="titr">تنظيمات آگهی</p><p class="lead">توضيحات اين بخش</p></div>
</div>
<!-- /section:ads/ads_setting.head -->
  ...
  <!-- vertical tab bootsnipp -->
    <div class="">
		...
		<hr>
		 ...
		 <!-- #section:ads/ads_setting.default -->
			 <?$ads_nav_picture=get_result("select address from new_default_navbar where name='ads_nav_picture'  and la='$la' and site='$site'",$coms_conect);?>
			<label class="col-md-3 control-label" for="family">تصویر پیش فرض ناوبری</label>
			<div class="form-group col-md-9">
				<div class="col-md-6 input-group">
				<input type="text" style="direction: ltr;" class="col-md-6 form-control" data-toggle="popover"  value="<?=$ads_nav_picture?>"  id="ads_nav_picture" name="ads_nav_picture">
				<span class="input-group-btn">
					<a href="/filemanager/dialog.php?type=1&amp;field_id=ads_nav_picture" class="btn btn-default iframe-btn" type="button" >انتخاب</a>
				</div>
			</div>
			<!-- /section:ads/ads_setting.default -->
		 </div>
            ...
            <div class="col-lg-3 col-md-3 col-sm-3 col-xs-3 bhoechie-tab-menu">
              <div class="list-group">
                <a href="#" class="list-group-item active text-center">
                  تنظيمات آگهی صفحه لیست 
                </a>
                <a href="#" class="list-group-item  text-center">
                   تنظيمات آگهی صفحه نمایش
                </a> 
                <a href="#" class="list-group-item  text-center">
                   تنظيمات آگهی صفحه دسته بندي
                </a> 
                <a href="#" class="list-group-item  text-center">
                   تنظيمات آگهی صفحه دسته جستجو
                </a> 
              </div>
            </div>
...
<!---------------------new_modual_tem_setting-------------تماس با ما هدر------------>
			   <div class="bhoechie-tab-content active">
					<!-- #section:ads/ads_setting.list -->
                    <center>
					<div class="form-group">
							<label class="col-md-3 control-label" for="family">نمايش تبليغات در صفحه اصلي</label> 
						<div class="form-group col-md-9">
							<div class="col-md-12 input-group">	
								<?$ads_have_ads=get_modual_setting_result($site,$la,'ads_have_ads',$coms_conect);?>
								<input type="checkbox" value="1" <?if($ads_have_ads==1) echo 'checked';?>   class="form-control" name="ads_have_ads" style="direction: ltr;float: right;width: 16px;margin-top: 0px;">
							</div>					
						</div>
					</div>
					<hr>
					<?$query="select title,link,pic_adress from new_tem_setting where name='ads_have_ads'  and la='$la' and site='$site'"; 
						$i=1;
...
<!---------------------فایل نمایش------------>
			   <div class="bhoechie-tab-content">
					<!-- #section:ads/ads_setting.view -->
                    <center>
					<div class="form-group">
							<label class="col-md-3 control-label" for="family">نمايش تبليغات در صفحه اصلي</label> 
						<div class="form-group col-md-9">
							<div class="col-md-12 input-group">	
								<?$ads_show_have_ads=get_modual_setting_result($site,$la,'ads_show_have_ads',$coms_conect);?>
								<input type="checkbox" value="1" <?if($ads_show_have_ads==1) echo 'checked';?>   class="form-control" name="ads_show_have_ads" style="direction: ltr;float: right;width: 16px;margin-top: 0px;">
							</div>					
						</div>
					</div>
					<hr>
					<?$query9="select title,link,pic_adress from new_tem_setting where name='ads_show_have_ads'  and la='$la' and site='$site'"; 
						$i=1;
...
<!----------------------------------صفحه دسته بندي------------------------>
			   <div class="bhoechie-tab-content ">
					<!-- #section:ads/ads_setting.cate -->
                    <center>
					<div class="form-group">
							<label class="col-md-3 control-label" for="family">نمايش تبليغات در صفحه دسته بندي</label> 
						<div class="form-group col-md-9">
							<div class="col-md-12 input-group">	
								<?$ads_cat_have_ads=get_modual_setting_result($site,$la,'ads_cat_have_ads',$coms_conect);?>
								<input type="checkbox" value="1" <?if($ads_cat_have_ads==1) echo 'checked';?>   class="form-control" name="ads_cat_have_ads" style="direction: ltr;float: right;width: 16px;margin-top: 0px;">
							</div>					
						</div>
					</div>
										<hr>
					<?$query11="select title,link,pic_adress from new_tem_setting where name='ads_cat_have_ads'  and la='$la' and site='$site'"; 
						//echo $query.'<br>';
						$i=1;
						$result11 = $coms_conect->query($query11);
...
<!----------------------------------صفحه دسته بندي------------------------>
			   <div class="bhoechie-tab-content ">
					<!-- #section:ads/ads_setting.search -->
                    <center>
					<div class="form-group">
							<label class="col-md-3 control-label" for="family">نمايش تبليغات در صفحه جستجو</label> 
						<div class="form-group col-md-9">
							<div class="col-md-12 input-group">	
								<?$ads_sesrch_have_ads=get_modual_setting_result($site,$la,'ads_sesrch_have_ads',$coms_conect);?>
								<input type="checkbox" value="1" <?if($ads_sesrch_have_ads==1) echo 'checked';?>   class="form-control" name="ads_sesrch_have_ads" style="direction: ltr;float: right;width: 16px;margin-top: 0px;">
							</div>					
						</div>
					</div>
										<hr>
					<?$query11="select title,link,pic_adress from new_tem_setting where name='ads_sesrch_have_ads'  and la='$la' and site='$site'"; 
						$i=1;
						$result11 = $coms_conect->query($query11);
						    while($RS11 = $result11->fetch_assoc()) {
							?>
							...
							<div class="form-group">
								...
								<div class="form-group col-md-9">
									<div class="col-md-12 input-group">
									<input type="text" style="direction: ltr;" class="col-md-12 form-control" readonly value="<?=$RS11["pic_adress"]?>"  id="image_search_ads1" name="image_search_ads<?=$i?>">
									<span class="input-group-btn">
