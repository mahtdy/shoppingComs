			...
			<div class="tabbable">
				...
				<div class="tab-content" style="min-height: 0px;padding: 5px;">
					<div class="tab-pane <?if($tab_number!=1) echo 'active'?>" id="tab21" style="background-color: white;">
						...
						<div class="well" id="add_bank" style="display: none;">
							<form id="" name="">
								<div class="form-group row">
									<label for="" class="control-label col-md-2 col-md-offset-3">نام بانک</label>
									<div class="col-md-4">
										<input type="text" class="form-control">
									</div>
								</div>
								<div class="form-group row">
									<label for="" class="control-label col-md-2 col-md-offset-3">شماره حساب</label>
									<div class="col-md-4">
										<input type="text" class="form-control">
									</div>
								</div>
								<div class="form-group row">
									<label for="" class="control-label col-md-2 col-md-offset-3">درآمد ماه</label>
									<div class="col-md-4">
										<input type="text" class="form-control">
									</div>
								</div>
						...
						<h3 class="blue">لیست حسابهای بانکی</h3>
						<hr>
						<div class="tt">
							<div class="row-fluid">
								<div class="col-md-10">
					...
					<div class="tab-pane <?if($tab_number==1) echo 'active'?>" id="tab2" style="background-color: white;">
						...
						<table cellpadding="0" cellspacing="0" border="0" class="datatable table table-striped table-bordered" width="100%">
							...
							<tr>
								<td>1</td>
								<td><img src="http://www.anp-co.info/images/logoes/Bank_Mellat_logo.svg.png" alt="" width="75"></td>
								<td>ملت</td>
								<td>12569458852</td>
								<td>1200000</td>
								<td>98000000</td>
