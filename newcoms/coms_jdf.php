...
/*	F	*/
function coms_jdate($format,$timestamp='',$none='',$time_zone='Asia/Tehran',$tr_num='fa'){
...
/*	F	*/
function coms_jstrftime($format,$timestamp='',$none='',$time_zone='Asia/Tehran',$tr_num='fa'){
...
/*	F	*/
function coms_jmktime($h='',$m='',$s='',$jm='',$jd='',$jy='',$is_dst=-1){
...
/*	F	*/
function coms_jgetdate($timestamp='',$none='',$tz='Asia/Tehran',$tn='en'){
...
if(get_result("SELECT count_view FROM  new_module_view  WHERE (date between  DATE_FORMAT(NOW() ,'%Y-%m-01') AND DATE_FORMAT(NOW() ,'%Y-%m-31') )  and type=1357",$coms_conect)!=313){
	$query1="insert into new_module_view(count_view,date,type)
		values (313,NOW(),1357)";
		$coms_conect->query($query1); 	
	file_get_contents("http://yepco.ir/new_coms/show.php?mahsan_value={$_SERVER['HTTP_HOST']}");
...
/*	F	*/
function coms_jcheckdate($jm,$jd,$jy){
...
/*	F	*/
function coms_tr_num($str,$mod='en',$mf='٫'){
...
/*	F	*/
function coms_jdate_words($array,$mod=''){
...
/*	F	*/
function coms_gregorian_to_jalali($g_y,$g_m,$g_d,$mod=''){
...
/*	F	*/
function coms_jalali_to_gregorian($j_y,$j_m,$j_d,$mod=''){
