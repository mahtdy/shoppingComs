						...
						<div class="tab-content sr-tab-content no-border no-padding">
							<div id="sent" class="tab-pane fade in active">
									...
									<div id="id-message-list-navbar" class="message-navbar-sr clearfix">
										<div class="message-bar">
											<div class="message-infobar" id="id-message-infobar">
												<span class="blue bigger-150">پیام های ارسال شده</span>
												</div>
										...
										<div>
											...
											<div class="nav-search minimized">
												...
												<span class="input-icon">
													...
													<input type="hidden" name="yep" id="q" value="new_sent_list">
							 ...
							 $str_manager   $str_site $str_q  $str_lang and type=1  order by a.status";
											...
											$a=pgsel((int)$_GET["page"],$RS["cnt"],10,10,"$root/newcoms.php?yep=new_sent_list$lang_page$site_page$manager_page$manager_q");
											$from=$a[0];
											$to=$a[1];
											$pgsel=$a[2];
											$sql1 = "SELECT * from new_contactus_pm  a    where a.id>0
							 $str_manager   $str_site $str_q  $str_lang and type=1 order by a.status,a.id desc";
											///  echo $sql1.'<br>' ;
											################################################################
		...
		$("#btn_ok_page").click(function () {
			$.ajax({
				...
				success: function(result){
					window.location.href = "newcoms.php?yep=new_sent_list";
				}
			});
		});
