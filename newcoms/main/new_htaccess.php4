...
//        fwrite($myfile, '	}'."\r\n");
    ...
    fwrite($myfile, 'if(count($url_temp)==3){'."\r\n");
        ...
        fwrite($myfile, '	if($url_temp[1]=="brand"){'."\r\n");
        fwrite($myfile, '	$madual_lang=injection_replace($url_temp[2])'.";\r\n");
        fwrite($myfile, '	$madual_file_name="new_profile_tem"'.";\r\n");
        fwrite($myfile, '	include("new_dynamic.php");exit;'.";\r\n");
        fwrite($myfile, '	}'."\r\n");

        fwrite($myfile, '	if($url_temp[1]=="catalog"){'."\r\n");
        fwrite($myfile, '	$madual_lang=injection_replace($url_temp[2])'.";\r\n");
        fwrite($myfile, '	$madual_file_name="new_catalog"'.";\r\n");
        fwrite($myfile, '	include("new_dynamic.php");exit;'.";\r\n");
        fwrite($myfile, '	}'."\r\n");

        fwrite($myfile, '	if($url_temp[1]=="company"){'."\r\n");
        fwrite($myfile, '	$madual_lang=injection_replace($url_temp[2])'.";\r\n");
        fwrite($myfile, '	$madual_file_name="new_company_tem"'.";\r\n");
        fwrite($myfile, '	include("new_dynamic.php");exit;'.";\r\n");
        fwrite($myfile, '	}'."\r\n");
        ...
        fwrite($myfile, '	$madual_lang=injection_replace($url_temp[2])'.";\r\n");
        fwrite($myfile, '	$madual_file_name="new_product"'.";\r\n");
        fwrite($myfile, '	include("new_dynamic.php");exit;'.";\r\n");
        fwrite($myfile, '	}'."\r\n");

        fwrite($myfile, '	if($url_temp[1]=="cart"){'."\r\n");
					fwrite($myfile, '	$madual_lang=injection_replace($url_temp[2])'.";\r\n");
					fwrite($myfile, '	$madual_file_name="new_cart"'.";\r\n");
					fwrite($myfile, '	include("new_dynamic.php");exit;'.";\r\n");
					fwrite($myfile, '	}'."\r\n");
	
					fwrite($myfile, '	if($url_temp[1]=="pay"){'."\r\n");
						fwrite($myfile, '	$madual_lang=injection_replace($url_temp[2])'.";\r\n");
						fwrite($myfile, '	$madual_file_name="new_pay_cart"'.";\r\n");
						fwrite($myfile, '	include("new_dynamic.php");exit;'.";\r\n");
						fwrite($myfile, '	}'."\r\n");
        ...
        fwrite($myfile, '	if($url_temp[1]=="rhinoplasty"){'."\r\n");
        fwrite($myfile, '	$madual_lang=injection_replace($url_temp[2])'.";\r\n");
        fwrite($myfile, '	$madual_file_name="new_rhinoplasty"'.";\r\n");
        fwrite($myfile, '	include("new_dynamic.php");exit;'.";\r\n");
        fwrite($myfile, '	}'."\r\n");

        fwrite($myfile, '	if($url_temp[1]=="bony-nose-surgery"){'."\r\n");
        fwrite($myfile, '	$madual_lang=injection_replace($url_temp[2])'.";\r\n");
        fwrite($myfile, '	$madual_file_name="new_bony_nose_surgery"'.";\r\n");
        fwrite($myfile, '	include("new_dynamic.php");exit;'.";\r\n");
        fwrite($myfile, '	}'."\r\n");

        fwrite($myfile, '	if($url_temp[1]=="otoplasty"){'."\r\n");
        fwrite($myfile, '	$madual_lang=injection_replace($url_temp[2])'.";\r\n");
        fwrite($myfile, '	$madual_file_name="new_otoplasty"'.";\r\n");
        fwrite($myfile, '	include("new_dynamic.php");exit;'.";\r\n");
        fwrite($myfile, '	}'."\r\n");

        fwrite($myfile, '	if($url_temp[1]=="drsheikhi-p1"){'."\r\n");
        fwrite($myfile, '	$madual_lang=injection_replace($url_temp[2])'.";\r\n");
        fwrite($myfile, '	$madual_file_name="new_drsheikhi_p1"'.";\r\n");
        fwrite($myfile, '	include("new_dynamic.php");exit;'.";\r\n");
        fwrite($myfile, '	}'."\r\n");
        fwrite($myfile, '	if($url_temp[1]=="drsheikhi-p2"){'."\r\n");
        fwrite($myfile, '	$madual_lang=injection_replace($url_temp[2])'.";\r\n");
        fwrite($myfile, '	$madual_file_name="new_drsheikhi_p2"'.";\r\n");
        fwrite($myfile, '	include("new_dynamic.php");exit;'.";\r\n");
        fwrite($myfile, '	}'."\r\n");
        fwrite($myfile, '	if($url_temp[1]=="drsheikhi-p3"){'."\r\n");
        fwrite($myfile, '	$madual_lang=injection_replace($url_temp[2])'.";\r\n");
        fwrite($myfile, '	$madual_file_name="new_drsheikhi_p3"'.";\r\n");
        fwrite($myfile, '	include("new_dynamic.php");exit;'.";\r\n");
        fwrite($myfile, '	}'."\r\n");
        fwrite($myfile, '	if($url_temp[1]=="drsheikhi-p4"){'."\r\n");
        fwrite($myfile, '	$madual_lang=injection_replace($url_temp[2])'.";\r\n");
        fwrite($myfile, '	$madual_file_name="new_drsheikhi_p4"'.";\r\n");
        fwrite($myfile, '	include("new_dynamic.php");exit;'.";\r\n");
        fwrite($myfile, '	}'."\r\n");
        fwrite($myfile, '	if($url_temp[1]=="drsheikhi-p5"){'."\r\n");
        fwrite($myfile, '	$madual_lang=injection_replace($url_temp[2])'.";\r\n");
        fwrite($myfile, '	$madual_file_name="new_drsheikhi_p5"'.";\r\n");
        fwrite($myfile, '	include("new_dynamic.php");exit;'.";\r\n");
        fwrite($myfile, '	}'."\r\n");
        fwrite($myfile, '	if($url_temp[1]=="drsheikhi-p6"){'."\r\n");
        fwrite($myfile, '	$madual_lang=injection_replace($url_temp[2])'.";\r\n");
        fwrite($myfile, '	$madual_file_name="new_drsheikhi_p6"'.";\r\n");
        fwrite($myfile, '	include("new_dynamic.php");exit;'.";\r\n");
        fwrite($myfile, '	}'."\r\n");
        fwrite($myfile, '	if($url_temp[1]=="drsheikhi-p7"){'."\r\n");
        fwrite($myfile, '	$madual_lang=injection_replace($url_temp[2])'.";\r\n");
        fwrite($myfile, '	$madual_file_name="new_drsheikhi_p7"'.";\r\n");
        fwrite($myfile, '	include("new_dynamic.php");exit;'.";\r\n");
        fwrite($myfile, '	}'."\r\n");
        fwrite($myfile, '	if($url_temp[1]=="drsheikhi-p8"){'."\r\n");
        fwrite($myfile, '	$madual_lang=injection_replace($url_temp[2])'.";\r\n");
        fwrite($myfile, '	$madual_file_name="new_drsheikhi_p7"'.";\r\n");
        fwrite($myfile, '	include("new_dynamic.php");exit;'.";\r\n");
        fwrite($myfile, '	}'."\r\n");
        fwrite($myfile, '	if($url_temp[1]=="drsheikhi-p9"){'."\r\n");
        fwrite($myfile, '	$madual_lang=injection_replace($url_temp[2])'.";\r\n");
        fwrite($myfile, '	$madual_file_name="new_drsheikhi_p7"'.";\r\n");
        fwrite($myfile, '	include("new_dynamic.php");exit;'.";\r\n");
        fwrite($myfile, '	}'."\r\n");
        fwrite($myfile, '	if($url_temp[1]=="drsheikhi-p10"){'."\r\n");
        fwrite($myfile, '	$madual_lang=injection_replace($url_temp[2])'.";\r\n");
        fwrite($myfile, '	$madual_file_name="new_drsheikhi_p7"'.";\r\n");
        fwrite($myfile, '	include("new_dynamic.php");exit;'.";\r\n");
        fwrite($myfile, '	}'."\r\n");
        fwrite($myfile, '	if($url_temp[1]=="drsheikhi-p11"){'."\r\n");
        fwrite($myfile, '	$madual_lang=injection_replace($url_temp[2])'.";\r\n");
        fwrite($myfile, '	$madual_file_name="new_drsheikhi_p11"'.";\r\n");
        fwrite($myfile, '	include("new_dynamic.php");exit;'.";\r\n");
        fwrite($myfile, '	}'."\r\n");
        fwrite($myfile, '	if($url_temp[1]=="drsheikhi-p12"){'."\r\n");
        fwrite($myfile, '	$madual_lang=injection_replace($url_temp[2])'.";\r\n");
        fwrite($myfile, '	$madual_file_name="new_drsheikhi_p12"'.";\r\n");
        fwrite($myfile, '	include("new_dynamic.php");exit;'.";\r\n");
        fwrite($myfile, '	}'."\r\n");
        fwrite($myfile, '	if($url_temp[1]=="drsheikhi-p13"){'."\r\n");
        fwrite($myfile, '	$madual_lang=injection_replace($url_temp[2])'.";\r\n");
        fwrite($myfile, '	$madual_file_name="new_drsheikhi_p13"'.";\r\n");
        fwrite($myfile, '	include("new_dynamic.php");exit;'.";\r\n");
        fwrite($myfile, '	}'."\r\n");
        fwrite($myfile, '	if($url_temp[1]=="drsheikhi-p14"){'."\r\n");
        fwrite($myfile, '	$madual_lang=injection_replace($url_temp[2])'.";\r\n");
        fwrite($myfile, '	$madual_file_name="new_drsheikhi_p14"'.";\r\n");
        fwrite($myfile, '	include("new_dynamic.php");exit;'.";\r\n");
        fwrite($myfile, '	}'."\r\n");
        fwrite($myfile, '	if($url_temp[1]=="drsheikhi-p15"){'."\r\n");
        fwrite($myfile, '	$madual_lang=injection_replace($url_temp[2])'.";\r\n");
        fwrite($myfile, '	$madual_file_name="new_drsheikhi_p15"'.";\r\n");
        fwrite($myfile, '	include("new_dynamic.php");exit;'.";\r\n");
        fwrite($myfile, '	}'."\r\n");
        fwrite($myfile, '	if($url_temp[1]=="Occupational-therapy"){'."\r\n");
        fwrite($myfile, '	$madual_lang=injection_replace($url_temp[2])'.";\r\n");
        fwrite($myfile, '	$madual_file_name="new_rasesh_p1"'.";\r\n");
        fwrite($myfile, '	include("new_dynamic.php");exit;'.";\r\n");
        fwrite($myfile, '	}'."\r\n");
        fwrite($myfile, '	if($url_temp[1]=="Speech-therapy"){'."\r\n");
        fwrite($myfile, '	$madual_lang=injection_replace($url_temp[2])'.";\r\n");
        fwrite($myfile, '	$madual_file_name="new_rasesh_p2"'.";\r\n");
        fwrite($myfile, '	include("new_dynamic.php");exit;'.";\r\n");
        fwrite($myfile, '	}'."\r\n");
        fwrite($myfile, '	if($url_temp[1]=="Dark-room"){'."\r\n");
        fwrite($myfile, '	$madual_lang=injection_replace($url_temp[2])'.";\r\n");
        fwrite($myfile, '	$madual_file_name="new_rasesh_p3"'.";\r\n");
        fwrite($myfile, '	include("new_dynamic.php");exit;'.";\r\n");
        fwrite($myfile, '	}'."\r\n");
        fwrite($myfile, '	if($url_temp[1]=="Play-therapy"){'."\r\n");
        fwrite($myfile, '	$madual_lang=injection_replace($url_temp[2])'.";\r\n");
        fwrite($myfile, '	$madual_file_name="new_rasesh_p4"'.";\r\n");
        fwrite($myfile, '	include("new_dynamic.php");exit;'.";\r\n");
        fwrite($myfile, '	}'."\r\n");
        fwrite($myfile, '	if($url_temp[1]=="Group-therapy"){'."\r\n");
        fwrite($myfile, '	$madual_lang=injection_replace($url_temp[2])'.";\r\n");
        fwrite($myfile, '	$madual_file_name="new_rasesh_p5"'.";\r\n");
        fwrite($myfile, '	include("new_dynamic.php");exit;'.";\r\n");
        fwrite($myfile, '	}'."\r\n");
...
fwrite($myfile, '	if($url_temp[1]=="reset_password"){'."\r\n");
		...
		fwrite($myfile, '	if($url_temp[1]=="ProfileShow"){'."\r\n");
		fwrite($myfile, '	$madual_lang=injection_replace($url_temp[2])'.";\r\n");
		fwrite($myfile, '	$madual_file_name="new_ProfileShow_EB"'.";\r\n");
		fwrite($myfile, '	include("new_dynamic.php");exit;'.";\r\n");
		fwrite($myfile, '	}'."\r\n");
...
//fwrite($myfile, '		$madual_lang=injection_replace($url_temp[2])'.";\r\n");
//fwrite($myfile, '		$url_temp[3]=="filter"'.";\r\n");
//fwrite($myfile, '		$madual_file_name="new_video"'.";\r\n");
//fwrite($myfile, '		include("new_dynamic.php");exit;'.";\r\n");
//fwrite($myfile, '	}'."\r\n");
		...
		fwrite($myfile, '	if($url_temp[1]=="brand"){'."\r\n");
        fwrite($myfile, '		$madual_lang=injection_replace($url_temp[2])'.";\r\n");
        fwrite($myfile, '		$url_temp[3]=="catalog"'.";\r\n");
		fwrite($myfile, '		$madual_file_name="new_catalog_tem"'.";\r\n");
		fwrite($myfile, '		include("new_dynamic.php");exit;'.";\r\n");
		fwrite($myfile, '	}'."\r\n");
...
##########################################	
	fwrite($myfile, 'if(count($url_temp)==5){'."\r\n");
        ...
        fwrite($myfile, '	$array=explode("?",$url_temp[4]);'."\r\n");
        fwrite($myfile, '	if(count($array)==2){'."\r\n");
        fwrite($myfile, '		$madual_lang=injection_replace($url_temp[2])'.";\r\n");
        fwrite($myfile, '		$madual_file_name="new_catalog_tem"'.";\r\n");
        fwrite($myfile, '		include("new_dynamic.php");exit;'.";\r\n");
