                        ...
                        <div class="tab-content sr-tab-content no-border no-padding">
                            <div id="draft" class="tab-pane fade in active">
                                        ...
                                        <div>
                                            ...
                                            <div class="nav-search minimized">
												...
												<span class="input-icon">
                                                    ...
                                                    <input type="hidden" name="yep" id="q" value="new_draft_list">
							 ...
							 $str_manager   $str_site $str_q  $str_lang and type=2 order by a.status";
                                            ...
                                            $a=pgsel((int)$_GET["page"],$RS["cnt"],10,10,"$root/newcoms.php?yep=new_draft_list$lang_page$site_page$manager_page$manager_q");
                                            $from=$a[0];
                                            $to=$a[1];
                                            $pgsel=$a[2];
                                            $sql1 = "SELECT * from new_contactus_pm  a    where a.id>0
							 $str_manager   $str_site $str_q  $str_lang and type=2 order by a.status,a.id desc";
                                            ///  echo $sql1.'<br>' ;
                                            ################################################################
        ...
        $("#btn_ok_page").click(function () {
            $.ajax({
                ...
                success: function(result){
                    window.location.href = "newcoms.php?yep=new_draft_list";
                }
            });
        });
        ...
        jQuery(function($){
            ...
            $('.message-list').on('click', '.message-item input[type=checkbox]' , function() {
                ...
                if(this.checked) Draft.display_bar(1);//display action toolbar when a message is selected
                    ...
                    Draft.display_bar($('.message-list input[type=checkbox]:checked').length);
            ...
            $('.message-list  .text').on('click', function() {
                ...
                $('#inbox-tabs a[href="#draft"]').parent().removeClass('active');
                //some waiting
                setTimeout(function() {
