	...
	<form class="form-horizontal" action="" method="post" name="city_name" id="city_name" enctype="multipart/form-data">	
		<div class="modal fade" id="city" tabindex="-1" role="dialog" aria-labelledby="city" aria-hidden="true">
			...
			<div class="modal-content">
				...
				<div class="modal-footer ">
					<button type="button" id="btn_ok" value="11" data-dismiss="modal" class="btn btn-primary"><span class="glyphicon glyphicon-ok-sign"></span>&nbsp;ذخيره</button>
				</div>
			</div>
			</div>
		</div>
	  ...
	  <!--ul class="nav nav-tabs">
			<li class="pull-right" >
				<button type="button" class="navbar-toggle btn-primary"  data-toggle="collapse" data-target="#bs-example-navbar-collapse-1">
					...
					<span data-toggle="tab" href="#write" title="افزودن آب و هوا"><i class="ace-icon fa fa-plus bigger-110"></i></span>
				</button>
			...
			<li class="pull-right">
				<button type="button" class="navbar-toggle btn-primary"  data-toggle="collapse" data-target="#bs-example-navbar-collapse-1">
					<span class="sr-only">Toggle navigation</span>
					<span data-toggle="modal" data-target="#city" href="#" title="شهرپیش فرض"><i class="ace-icon fa fa-pencil bigger-110"></i></span>
				</button>
				<div class="collapse navbar-collapse" id="nav-collapse">
					<ul class="nav navbar-nav navbar-left">
			...
			<div class="toolmenu">
				<ul>
					...
					<li id="newpag" class="addicon">
						<a data-toggle="tab" href="#write" data-placement="bottom" title="افزودن آب و هوا" >
				...
				<form class="form-horizontal" action="" method="post" name="add_weather" id="add_weather" enctype="multipart/form-data">			
					<div id="id-message-new-navbar" class="message-navbar clearfix">
						...
						<!--div class="message-bar">
							<h2 style="color: #2a8bcb;">افزودن آب و هوا/ ویرایش</h2>
						</div-->
						<!--div>
