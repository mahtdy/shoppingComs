...
if($_POST['send_flag']==1){ 
	...
	$question_show_all_nave_link=injection_replace($_POST["question_show_all_nave_link"]);
	$question_show_all_nave_pic=injection_replace($_POST["question_show_all_nave_pic"]);
	$question_show_all_nave_text=injection_replace($_POST["question_show_all_nave_text"]);
	$question_show_all_nave_title=injection_replace($_POST["question_show_all_nave_title"]);
 	insert_templdate($site,$question_show_all_nave_pic,$la,$question_show_all_nave_text,$question_show_all_nave_title,$question_show_all_nave_link,'',"question_show_all_nave",'default',$coms_conect);
	 
	 
	$question_show_nave_link=injection_replace($_POST["question_show_nave_link"]);
	$question_show_nave_text=injection_replace($_POST["question_show_nave_text"]);
	$question_show_nave_title=injection_replace($_POST["question_show_nave_title"]);
	$question_show_nave_pic=injection_replace($_POST["question_show_nave_pic"]);
 	insert_templdate($site,$question_show_nave_pic,$la,$question_show_nave_text,$question_show_nave_title,$question_show_nave_link,'',"question_show_nave",'default',$coms_conect);
	
	
	$question_new_nave_link=injection_replace($_POST["question_new_nave_link"]);
	$question_new_nave_text=injection_replace($_POST["question_new_nave_text"]);
	$question_new_nave_title=injection_replace($_POST["question_new_nave_title"]);
	$question_new_nave_picture=injection_replace($_POST["question_new_nave_picture"]);
	$question_new_nave_pic=injection_replace($_POST["question_new_nave_pic"]);
 	insert_templdate($site,$question_new_nave_pic,$la,$question_new_nave_text,$question_new_nave_title,$question_new_nave_link,$question_new_nave_picture,"question_new_nave",'default',$coms_conect);
	  	 
	 
	$question_base_setting_link=injection_replace($_POST["question_base_setting_link"]);
	$question_base_setting_text=injection_replace($_POST["question_base_setting_text"]);
	$question_base_setting_title=injection_replace($_POST["question_base_setting_title"]);
	$question_base_setting_pic=injection_replace($_POST["question_base_setting_pic"]);
 	insert_templdate($site,'',$la,$question_base_setting_text,$question_base_setting_title,$question_base_setting_link,$question_base_setting_pic,"question_base_setting",'default',$coms_conect);
...
####صفحه اصلي
	$question_have_ads=injection_replace_pic($_POST["question_have_ads"]);
	if($question_have_ads!=1) $question_have_ads=0;
	insert_ads_templdate($site,$la,$question_have_ads,'question_have_ads',$coms_conect);
 	$query1="delete from new_tem_setting where name='question_have_ads' and la='$la'"; 
	...
	for($i=1;$i<=$ads_count;$i++){ 
		...
		insert_news_templdate($site,$header_pic,$la,'',$title_ads,$header_link,'',"question_have_ads",'',$coms_conect);
	} 
####فایل نمایش
	$question_show_have_ads=injection_replace_pic($_POST["question_show_have_ads"]);
	if($question_show_have_ads!=1) $question_show_have_ads=0;
	insert_ads_templdate($site,$la,$question_show_have_ads,'question_show_have_ads',$coms_conect);
 	$query1="delete from new_tem_setting where name='question_show_have_ads' and la='$la'"; 
	$coms_conect->query($query1);
	for($i=1;$i<=$ads_show_count;$i++){ 
		...
		insert_news_templdate($site,$header_show_pic,$la,'',$title_show_ads,$header_show_link,'',"question_show_have_ads",'',$coms_conect);
	}	
#######دسته بندي
	$question_new_have_ads=injection_replace_pic($_POST["question_new_have_ads"]);
	if($question_new_have_ads!=1) $question_new_have_ads=0;
	insert_ads_templdate($site,$la,$question_new_have_ads,'question_new_have_ads',$coms_conect);
	$query1="delete from new_tem_setting where name='question_new_have_ads'  and la='$la'"; 
	$coms_conect->query($query1);
	for($i=1;$i<=$ads_cat_count;$i++){	
		...
		insert_news_templdate($site,$image_cat_ads,$la,'',$title_cat_ads,$link_cat_ads,'',"question_new_have_ads",'',$coms_conect);
	}
	...
	<div class="msheet tab-content">
		<div class="secfhead">
			...
			<div class="sectitle">
				...
				<div class="title"><p class="titr">تنظيمات پرسش و پاسخ </p><p class="lead">توضيحات اين بخش</p></div>
			</div>
			<!-- /section:news/news_setting.head -->
				...
				<div class="collapse in" id="" style="padding: 10px;">
					<div> 
						...
						<div class="tab-content" style="padding: 10px 50px;"> 
							...
							<?$question_base_setting= get_tem_result($site,$la,"question_base_setting",'default',$coms_conect);?>
								<div class="sr-sms-account">
									<h3 class="sr-yellow">
										تنظیمات پایه پرسش و پاسخ :
									</h3>
									<hr>
									...
									<div class="sr-sms-settings-text">
										...
										<label class="col-md-5 col-xs-12">
											<input  value='1' <?if($question_base_setting['title']==1)echo 'checked';?>    name="question_base_setting_title" class="ace ace-switch ace-switch-7 conchkNumber_4" type="checkbox">
									...
									<div class="sr-sms-settings-text">
										<h4 class="col-md-7 col-xs-12">
											تعیین تعداد پرسش های نمایش داده شده در صفحه اختصاصی پرسش و پاسخ
	  
										</h4>
										
										<label class="sr-input col-md-5 col-xs-12">
											<input class="input-sm " type="number" value="<?=$question_base_setting['text']?>" name="question_base_setting_text">
										</label>
										<p class="sr-sms-bshadow sr-sms-help">
											<i class="fa fa-question-circle" aria-hidden="true"></i>
											شما با این گزینه می توانید تعداد پرسش های نمایش داده شده در صفحه پرسش و پاسخ را تعیین کنید.
										</p>
									</div>
									<div class="sr-sms-settings-text">
										<h4 class="col-md-7 col-xs-12">
										...
										<label class="sr-input col-md-5 col-xs-12">
											<input class="input-sm " type="number" value="<?=$question_base_setting['link']?>" name="question_base_setting_link">
										</label>
										<p class="sr-sms-bshadow sr-sms-help">
											<i class="fa fa-question-circle" aria-hidden="true"></i>
									...
									<div class="sr-sms-settings-text">
										<h4 class="col-md-7 col-xs-12">
											تعداد برچسب های مجازی برای کاربران سایت
	  
										</h4>
										
										<label class="sr-input col-md-5 col-xs-12">
											<input class="input-sm " type="number" value="<?=$question_base_setting['pic']?>" name="question_base_setting_pic">
										</label>
										<p class="sr-sms-bshadow sr-sms-help">
											<i class="fa fa-question-circle" aria-hidden="true"></i>
											در صورت فعال سازی این گزینه کاربر حداکثر می تواند به تعداد تعیین شده برچسب به سوال خود اضافه نماید و در صورت قراردادن صفر تعداد نامحدود می باشد.
										</p>
									</div>
								</div>
								...
								<div class="col-md-12 bhoechie-tab-container"><br>
									<div class="col-lg-4 col-md-4 col-sm-4 col-xs-4 bhoechie-tab-menu">
									  <div class="list-group">
										...
										تبلیغات صفحه سوالات متداولها و دسته بندی و برچسب
										</a>
						...
						<!---------------------new_modual_tem_setting-------------تماس با ما هدر------------>
									   ...
									   <!-- #section:news/news_setting.list -->
											...
											<div class="form-group">
													<label class="col-md-3 control-label" for="family">نمايش تبليغات در صفحه سوالات متداول، صصفحه نمایش، صفحه دسته بندی</label> 
												<div class="form-group col-md-9">
													<div class="col-md-12 input-group">	
														<?$question_have_ads=get_modual_setting_result($site,$la,'question_have_ads',$coms_conect);?>
														<input type="checkbox" value="1" <?if($question_have_ads==1) echo 'checked';?>   class="form-control"  name="question_have_ads" style="direction: ltr;float: right;width: 16px;margin-top: 0px;">
													</div>					
												</div>
											</div>
											<hr>
											<?$query="select title,link,pic_adress from new_tem_setting where name='question_have_ads'  and la='$la' and site='$site'"; 
												$i=1;
									   ...
									   <div class="bhoechie-tab-content">
										<!-- #section:news/news_setting.view -->
											...
											<div class="form-group">
												...
												<div class="form-group col-md-9">
													<div class="col-md-12 input-group">	
														<?$question_show_have_ads=get_modual_setting_result($site,$la,'question_show_have_ads',$coms_conect);?>
														<input type="checkbox" value="1" <?if($question_show_have_ads==1) echo 'checked';?>   class="form-control" name="question_show_have_ads" style="direction: ltr;float: right;width: 16px;margin-top: 0px;">
													</div>					
												</div>
											</div>
											<hr>
											<?$query9="select title,link,pic_adress from new_tem_setting where name='question_show_have_ads'  and la='$la' and site='$site'"; 
												$i=1;
						...
						<!----------------------------------صفحه دسته بندي------------------------>
									   ...
									   <!-- #section:news/news_setting.cate -->
											...
											<div class="form-group">
												...
												<div class="form-group col-md-9">
													<div class="col-md-12 input-group">	
														<?$question_new_have_ads=get_modual_setting_result($site,$la,'question_new_have_ads',$coms_conect);?>
														<input type="checkbox" value="1" <?if($question_new_have_ads==1) echo 'checked';?>   class="form-control" name="question_new_have_ads" style="direction: ltr;float: right;width: 16px;margin-top: 0px;">
													</div>					
												</div>
											</div>
																<hr>
											<?$query11="select title,link,pic_adress from new_tem_setting where name='question_new_have_ads'  and la='$la' and site='$site'"; 
												//echo $query.'<br>';
												$i=1;
												$result11 = $coms_conect->query($query11);
						...
						<!----------------------->	
							...
							<div role="tabpanel" class="tab-pane <?if($menu_tab==3)echo 'active'?>" id="nav_set">
								...
								<div class="sr-sms-account">
									<h3 class="sr-yellow">
								تنظیمات تصویر ناوبری صفحه نمایش پرسش و پاسخ 
									</h3>
								<hr>
									<?$question_show_nave= get_tem_result($site,$la,"question_show_nave",'default',$coms_conect);?>
									<div class="sr-sms-settings-text sr-sms-bshadow ">
										...
										<div class="row form-group">
											...
											<div class="col-sm-6">
												<input id="register_title" value="<?=$question_show_nave['title']?>" name="question_show_nave_title" class="form-control"/>
											</div>
										</div> 
										...
										<div class="row form-group">
											...
											<div class="col-sm-6">
												<input type="text" value="<?=$question_show_nave['text']?>" id="question_show_nave_text" name="question_show_nave_text" class="form-control" />
											</div>
										</div> 
										...
										<div class="row form-group">
											...
											<div class="col-sm-6">
												<input type="text" value="<?=$question_show_nave['link']?>" id="question_show_nave_link" name="question_show_nave_link" class="form-control" />
											</div>
										</div> 
										...
										<div class="row form-group">
											...
											<div class="col-sm-6">
												<div class="col-md-12 input-group">
													<input type="text" style="direction: ltr;" class="col-md-10"  value="<?=$question_show_nave['pic_adress']?>"  data-toggle="popover" id="question_show_nave_pic" name="question_show_nave_pic">
													<a href="/filemanager/dialog.php?type=1&amp;field_id=question_show_nave_pic" class="btn iframe-btn" type="button" style="top: 2px;height: 38px;padding-top: 9px;  float: right;">انتخاب</a>
												</div>
											</div>
										</div> 
								...
								<hr>
									<?$question_show_all_nave= get_tem_result($site,$la,"question_show_all_nave",'default',$coms_conect);?>
									<div class="sr-sms-settings-text sr-sms-bshadow ">
									 <h3 class="sr-yellow">
										...
										<div class="row form-group">
											...
											<div class="col-sm-6">
												<input id="question_show_all_nave_title" value="<?=$question_show_all_nave['title']?>" name="question_show_all_nave_title" class="form-control"/>
											</div>
										</div> 
										...
										<div class="row form-group">
											...
											<div class="col-sm-6">
												<input type="text" value="<?=$question_show_all_nave['text']?>" id="question_show_all_nave" name="question_show_all_nave_text" class="form-control" />
											</div>
										</div> 
										...
										<div class="row form-group">
											...
											<div class="col-sm-6">
												<input type="text" value="<?=$question_show_all_nave['link']?>" id="question_show_all_nave_link" name="question_show_all_nave_link" class="form-control" />
											</div>
										</div> 
										...
										<div class="row form-group">
											...
											<div class="col-sm-6">
												<div class="col-md-12 input-group">
													<input type="text" style="direction: ltr;" class="col-md-10"  value="<?=$question_show_all_nave['pic_adress']?>"  data-toggle="popover" id="question_show_all_nave_pic" name="question_show_all_nave_pic">
													<a href="/filemanager/dialog.php?type=1&amp;field_id=question_show_all_nave_pic" class="btn iframe-btn" type="button" style="top: 2px;height: 38px;padding-top: 9px;  float: right;">انتخاب</a>
												</div>
											</div>
										</div> 
								...
								<hr>
									<?$question_new_nave= get_tem_result($site,$la,"question_new_nave",'default',$coms_conect);?>
									<div class="sr-sms-settings-text sr-sms-bshadow ">
									    <h3 class="sr-yellow">
										...
										<div class="row form-group">
											...
											<div class="col-sm-6">
												<input id="question_new_nave_title" value="<?=$question_new_nave['title']?>" name="question_new_nave_title" class="form-control"/>
											</div>
										</div> 
										...
										<div class="row form-group">
											...
											<div class="col-sm-6">
												<input type="text" value="<?=$question_new_nave['text']?>" id="question_new_nave_text" name="question_new_nave_text" class="form-control" />
											</div>
										</div> 
										...
										<div class="row form-group">
											...
											<div class="col-sm-6">
												<input type="text" value="<?=$question_new_nave['link']?>" id="question_new_nave_link" name="question_new_nave_link" class="form-control" />
											</div>
										</div> 
										...
										<div class="row form-group">
											...
											<div class="col-sm-6">
												<div class="col-md-12 input-group">
													<input type="text" style="direction: ltr;" class="col-md-10"  value="<?=$question_new_nave['pic_adress']?>"  data-toggle="popover" id="question_new_nave_pic" name="question_new_nave_pic">
													<a href="/filemanager/dialog.php?type=1&amp;field_id=question_new_nave_pic" class="btn iframe-btn" type="button" style="top: 2px;height: 38px;padding-top: 9px;  float: right;">انتخاب</a>
												</div>
											</div>
										</div> 
										...
										<div class="row form-group">
											...
											<div class="col-sm-6">
												<input type="text" value="<?=$question_new_nave['pic']?>" id="question_new_nave_picture" name="question_new_nave_picture" class="form-control" />
											</div>
										</div> 										
