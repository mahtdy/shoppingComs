...
if($_POST['send_flag']==1){ 
     check_token( $_REQUEST[ 'user_token' ], $_SESSION[ 'session_token' ], '/coms' ); 
		...
		#####اندازه تصاویر
	$content_pic_size=injection_replace_pic($_POST["content_pic_size"]);
	$query11="SELECT id from new_default_navbar where name='content_pic_size' and la='fa' and site='main'";
	//echo $query11.'<br>';
	$result11 = $coms_conect->query($query11); 
	$row11 = mysqli_num_rows($result11);
	if ($row11> 0) {
	   $query="update new_default_navbar set address='$content_pic_size' where name='content_pic_size'  and la='fa'  and site='main'"; 
	   $coms_conect->query($query);
	}else{
     	$query="insert into new_default_navbar(site,address,la,name)values('main','$content_pic_size','fa','content_pic_size')";
     	$coms_conect->query($query);
	} 
	 ...
	 #####پیش فرض ناوبری	 
	$content_nav_picture=injection_replace_pic($_POST["content_nav_picture"]);
	$query11="SELECT id from new_default_navbar where name='content_nav_picture' and la='$la' and site='$site'";
	//echo $query11.'<br>';
	$result11 = $coms_conect->query($query11);
	$row11 = mysqli_num_rows($result11);
	if ($row11> 0) {
	   $query="update new_default_navbar set address='$content_nav_picture' where name='content_nav_picture'  and la='$la'  and site='$site'"; 
	   $coms_conect->query($query);
	}else{
     	$query="insert into new_default_navbar(site,address,la,name)values('$site','$content_nav_picture','$la','content_nav_picture')";
     	$coms_conect->query($query);
	}
####صفحه اصلي
	$content_have_ads=injection_replace_pic($_POST["content_have_ads"]);
	if($content_have_ads!=1) $content_have_ads=0;
	insert_ads_templdate($site,$la,$content_have_ads,'content_have_ads',$coms_conect);
 	$query1="delete from new_tem_setting where name='content_have_ads' and la='$la'"; 
	...
	for($i=1;$i<=$ads_count;$i++){ 
		...
		insert_news_templdate($site,$header_pic,$la,'',$title_ads,$header_link,'',"content_have_ads",'',$coms_conect);
	} 
####فایل نمایش
	$content_show_have_ads=injection_replace_pic($_POST["content_show_have_ads"]);
	if($content_show_have_ads!=1) $content_show_have_ads=0;
	insert_ads_templdate($site,$la,$content_show_have_ads,'content_show_have_ads',$coms_conect);
 	$query1="delete from new_tem_setting where name='content_show_have_ads' and la='$la'"; 
	$coms_conect->query($query1);
	for($i=1;$i<=$ads_show_count;$i++){ 
		...
		insert_news_templdate($site,$header_show_pic,$la,'',$title_show_ads,$header_show_link,'',"content_show_have_ads",'',$coms_conect);
	}	
#######دسته بندي
	$content_cat_have_ads=injection_replace_pic($_POST["content_cat_have_ads"]);
	if($content_cat_have_ads!=1) $content_cat_have_ads=0;
	insert_ads_templdate($site,$la,$content_cat_have_ads,'content_cat_have_ads',$coms_conect);
	$query1="delete from new_tem_setting where name='content_cat_have_ads'  and la='$la'"; 
	$coms_conect->query($query1);
	for($i=1;$i<=$ads_cat_count;$i++){	
		...
		insert_news_templdate($site,$image_cat_ads,$la,'',$title_cat_ads,$link_cat_ads,'',"content_cat_have_ads",'',$coms_conect);
	}

######جستجو	
	$content_sesrch_have_ads=injection_replace_pic($_POST["content_sesrch_have_ads"]);
	if($content_sesrch_have_ads!=1) $content_sesrch_have_ads=0;
	insert_ads_templdate($site,$la,$content_sesrch_have_ads,'content_sesrch_have_ads',$coms_conect);
	$query1="delete from new_tem_setting where name='content_sesrch_have_ads'  and la='$la'"; 
	$coms_conect->query($query1);
	for($i=1;$i<=$ads_search_count;$i++){ 
		...
		insert_news_templdate($site,$image_search_ads,$la,'',$title_search_ads,$link_search_ads,'',"content_sesrch_have_ads",'',$coms_conect);
	}
}
...
<div class="title"><p class="titr">تنظيمات محتوا</p><p class="lead">توضيحات اين بخش</p></div>
</div>
<!-- /section:news/news_setting.head -->
    ...
    <div class="">
	    ...
	    <div class="form-group col-md-12">
			<!-- #section:news/news_setting.default -->
			 <?$content_nav_picture=get_result("select address from new_default_navbar where name='content_nav_picture'  and la='$la' and site='$site'",$coms_conect);?>
			<label class="col-md-3 control-label" for="family">تصویر پیش فرض ناوبری</label>
			<div class="form-group col-md-9">
				<div class="col-md-6 input-group">
				<input type="text" style="direction: ltr;" class="col-md-6"   value="<?=$content_nav_picture?>" data-toggle="popover" id="content_nav_picture" name="content_nav_picture">
				<a href="/filemanager/dialog.php?type=1&amp;field_id=content_nav_picture" class="btn iframe-btn" type="button" style="top: 2px;height: 40px;padding-top: 6px;  float: right;">انتخاب</a>
				</div>
			</div>
			
			 <?$content_pic_size=get_result("select address from new_default_navbar where name='content_pic_size'  and la='fa' and site='main'",$coms_conect);?>
			<label class="col-md-3 control-label" for="family">تنظیمات اندازه تصاویر</label>
			<div class="form-group col-md-9">
				<div class="col-md-5 input-group">
				<input type="text" style="direction: ltr;" class="col-md-6 form-control"    value="<?=$content_pic_size?>"  id="content_pic_size" name="content_pic_size">
			 	</div><span class="col-md-1"></span>
				<div class="col-md-6 well well-sm">مقدار عددی وارد شده در این قسمت نشانگر عرض تصویر می باشد</div>
			</div>
			
			<!-- /section:content/content_setting.default -->
		 </div>
		 <div class="col-md-12 bhoechie-tab-container"><br>
            <div class="col-lg-3 col-md-3 col-sm-3 col-xs-3 bhoechie-tab-menu">
              <div class="list-group">
                <a href="#" class="list-group-item active text-center">
                  تنظيمات محتوا صفحه لیست 
                </a>
                <a href="#" class="list-group-item  text-center">
                   تنظيمات محتوا صفحه نمایش
                </a> 
                <a href="#" class="list-group-item  text-center">
                   تنظيمات محتوا صفحه دسته بندی
                </a> 
                <a href="#" class="list-group-item  text-center">
                   تنظيمات محتوا صفحه دسته جستجو
                </a> 
              </div>
            </div>
...
<!---------------------new_modual_tem_setting-------------تماس با ما هدر------------>
			   ...
			   <!-- #section:content/content_setting.list -->
                    <center>
					<div class="form-group">
							<label class="col-md-3 control-label" for="family">نمايش تبليغات در صفحه اصلی</label> 
						<div class="form-group col-md-9">
							<div class="col-md-12 input-group">	
								<?$content_have_ads=get_modual_setting_result($site,$la,'content_have_ads',$coms_conect);?>
								<input type="checkbox" value="1" <?if($content_have_ads==1) echo 'checked';?>   class="form-control"  name="content_have_ads" style="direction: ltr;float: right;width: 16px;margin-top: 0px;">
							</div>					
						</div>
					</div>
					<hr>
					<?$query="select title,link,pic_adress from new_tem_setting where name='content_have_ads'  and la='$la' and site='$site'"; 
						$i=1;
...
<!---------------------فایل نمایش------------>
			   <div class="bhoechie-tab-content">
				<!-- #section:content/content_setting.view -->
                    <center>
					<div class="form-group">
							<label class="col-md-3 control-label" for="family">نمايش تبليغات در صفحه اصلی</label> 
						<div class="form-group col-md-9">
							<div class="col-md-12 input-group">	
								<?$content_show_have_ads=get_modual_setting_result($site,$la,'content_show_have_ads',$coms_conect);?>
								<input type="checkbox" value="1" <?if($content_show_have_ads==1) echo 'checked';?>   class="form-control" name="content_show_have_ads" style="direction: ltr;float: right;width: 16px;margin-top: 0px;">
							</div>					
						</div>
					</div>
					<hr>
					<?$query9="select title,link,pic_adress from new_tem_setting where name='content_show_have_ads'  and la='$la' and site='$site'"; 
						$i=1;
...
<!----------------------------------صفحه دسته بندي------------------------>
			   <div class="bhoechie-tab-content ">
			   <!-- #section:content/content_setting.cate -->
                    <center>
					<div class="form-group">
							<label class="col-md-3 control-label" for="family">نمايش تبليغات در صفحه دسته بندی</label> 
						<div class="form-group col-md-9">
							<div class="col-md-12 input-group">	
								<?$content_cat_have_ads=get_modual_setting_result($site,$la,'content_cat_have_ads',$coms_conect);?>
								<input type="checkbox" value="1" <?if($content_cat_have_ads==1) echo 'checked';?>   class="form-control" name="content_cat_have_ads" style="direction: ltr;float: right;width: 16px;margin-top: 0px;">
							</div>					
						</div>
					</div>
										<hr>
					<?$query11="select title,link,pic_adress from new_tem_setting where name='content_cat_have_ads'  and la='$la' and site='$site'"; 
						//echo $query.'<br>';
						$i=1;
						$result11 = $coms_conect->query($query11);
...
<!----------------------------------صفحه دسته بندي------------------------>
			   <div class="bhoechie-tab-content ">
			   <!-- #section:content/content_setting.search -->
                    <center>
					<div class="form-group">
							<label class="col-md-3 control-label" for="family">نمايش تبليغات در صفحه جستجو</label> 
						<div class="form-group col-md-9">
							<div class="col-md-12 input-group">	
								<?$content_sesrch_have_ads=get_modual_setting_result($site,$la,'content_sesrch_have_ads',$coms_conect);?>
								<input type="checkbox" value="1" <?if($content_sesrch_have_ads==1) echo 'checked';?>   class="form-control" name="content_sesrch_have_ads" style="direction: ltr;float: right;width: 16px;margin-top: 0px;">
							</div>					
						</div>
					</div>
										<hr>
					<?$query11="select title,link,pic_adress from new_tem_setting where name='content_sesrch_have_ads'  and la='$la' and site='$site'"; 
						$i=1;
						$result11 = $coms_conect->query($query11);
						    while($RS11 = $result11->fetch_assoc()) {
							?>
