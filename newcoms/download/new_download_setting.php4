...
check_token( $_REQUEST[ 'user_token' ], $_SESSION[ 'session_token' ], '/coms' );	
	 ...
	 #####پیش فرض ناوبری	 
	$download_nav_picture=injection_replace_pic($_POST["download_nav_picture"]);
	$query11="SELECT id from new_default_navbar where name='download_nav_picture' and la='$la' and site='$site'";
	//echo $query11.'<br>';
	$result11 = $coms_conect->query($query11);
	$row11 = mysqli_num_rows($result11);
	if ($row11> 0) {
	   $query="update new_default_navbar set address='$download_nav_picture' where name='download_nav_picture'  and la='$la'  and site='$site'"; 
	   $coms_conect->query($query);
	}else{
     	$query="insert into new_default_navbar(site,address,la,name)values('$site','$download_nav_picture','$la','download_nav_picture')";
     	$coms_conect->query($query);
	}
####صفحه اصلي
	$download_have_ads=injection_replace_pic($_POST["download_have_ads"]);
	if($download_have_ads!=1) $download_have_ads=0;
	insert_ads_templdate($site,$la,$download_have_ads,'download_have_ads',$coms_conect);
 	$query1="delete from new_tem_setting where name='download_have_ads'"; 
	...
	for($i=1;$i<=$ads_count;$i++){ 
		...
		insert_news_templdate($site,$header_pic,$la,'',$title_ads,$header_link,'',"download_have_ads",'',$coms_conect);
	} 
####فایل نمایش
	$download_show_have_ads=injection_replace_pic($_POST["download_show_have_ads"]);
	if($download_show_have_ads!=1) $download_show_have_ads=0;
	insert_ads_templdate($site,$la,$download_show_have_ads,'download_show_have_ads',$coms_conect);
 	$query1="delete from new_tem_setting where name='download_show_have_ads'"; 
	$coms_conect->query($query1);
	for($i=1;$i<=$ads_show_count;$i++){ 
		...
		insert_news_templdate($site,$header_show_pic,$la,'',$title_show_ads,$header_show_link,'',"download_show_have_ads",'',$coms_conect);
	}	
#######دسته بندي
	$download_cat_have_ads=injection_replace_pic($_POST["download_cat_have_ads"]);
	if($download_cat_have_ads!=1) $download_cat_have_ads=0;
	insert_ads_templdate($site,$la,$download_cat_have_ads,'download_cat_have_ads',$coms_conect);
	$query1="delete from new_tem_setting where name='download_cat_have_ads'"; 
	$coms_conect->query($query1);
	for($i=1;$i<=$ads_cat_count;$i++){	
		...
		insert_news_templdate($site,$image_cat_ads,$la,'',$title_cat_ads,$link_cat_ads,'',"download_cat_have_ads",'',$coms_conect);
	}

######جستجو	
	$download_sesrch_have_ads=injection_replace_pic($_POST["download_sesrch_have_ads"]);
	if($download_sesrch_have_ads!=1) $download_sesrch_have_ads=0;
	insert_ads_templdate($site,$la,$download_sesrch_have_ads,'download_sesrch_have_ads',$coms_conect);
	$query1="delete from new_tem_setting where name='download_sesrch_have_ads'"; 
	$coms_conect->query($query1);
	for($i=1;$i<=$ads_search_count;$i++){ 
		...
		insert_news_templdate($site,$image_search_ads,$la,'',$title_search_ads,$link_search_ads,'',"download_sesrch_have_ads",'',$coms_conect);
	}

######راهنمای دانلود
		$download_have_help=injection_replace_pic($_POST["download_have_help"]);
		insert_news_templdate($site,'',$la,$download_have_help,'','','',"download_have_help",'defualt',$coms_conect);
...
<div class="tabbable">
	...
	<div class="secfhead">
<!-- #section:download/download_setting.head -->
<div class="sectitle">
<div class="icon"><span class="flaticon-file23" style=""></span></div>
<div class="title"><p class="titr">تنظيمات دانلود</p><p class="lead">توضيحات اين بخش</p></div>
</div>
<!-- /section:download/download_setting.head -->
    ...
    <div class="">
		...
		<hr>
		 <div class="form-group col-md-12">
			<!-- #section:download/download_setting.default -->
			 <?$download_nav_picture=get_result("select address from new_default_navbar where name='download_nav_picture'  and la='$la' and site='$site'",$coms_conect);?>
			<label class="col-md-3 control-label" for="family">تصویر پیش فرض ناوبری</label>
			<div class="form-group col-md-9">
				<div class="col-md-6 input-group">
				<input type="text" style="direction: ltr;" class="col-md-6 form-control" data-toggle="popover"   value="<?=$download_nav_picture?>"  id="download_nav_picture" name="download_nav_picture">
				<span class="input-group-btn"><a href="/filemanager/dialog.php?type=1&amp;field_id=download_nav_picture" class="btn iframe-btn" type="button" >انتخاب</a>
				</div>
			</div>
			<!-- /section:download/download_setting.default -->
		 </div>
              ...
              <div class="list-group">
			   <a href="#" class="list-group-item active text-center">
                ...
                <a href="#" class="list-group-item   text-center">
                  تنظيمات دانلود صفحه لیست 
                </a>
                <a href="#" class="list-group-item  text-center">
                   تنظيمات دانلود صفحه نمایش
                </a> 
                <a href="#" class="list-group-item  text-center">
                   تنظيمات دانلود صفحه دسته بندي
                </a> 
                <a href="#" class="list-group-item  text-center">
                   تنظيمات دانلود صفحه دسته جستجو
                </a> 
              </div>
            </div>
            <div class="col-lg-9 col-md-9 col-sm-9 col-xs-9 bhoechie-tab">
			<!---------------------new_modual_tem_setting------------ ------------>
			   <div class="bhoechie-tab-content active">
				<!-- #section:download/download_setting.list -->
                    <center>
 							<div class="form-group">
								<label class="col-md-3 control-label" for="family">تصوير تبليغ#<?=$i?></label>
								<div class="form-group col-md-9">
									<div class="col-md-12 input-group">
									<?$download_have_help=get_result("select text from new_tem_setting where name='download_have_help'  and la='$la' and site='$site'",$coms_conect);?>
									<textarea type="text" style="direction: ltr;" class="col-md-12 form-control" id="download_have_help"  name="download_have_help"><?=$download_have_help?></textarea>
								 	</div>
								</div>
							</div>
					 									<script>
														 tinymce.init({
															 selector: "#download_have_help",
															 height: 300,
															 width:"99.5%",
															 directionality : 'rtl',
															 language : 'fa_IR',
			   ...
			   <div class="bhoechie-tab-content  ">
				<!-- #section:download/download_setting.list -->
					...
					<div class="form-group">
						...
						<div class="form-group col-md-9">
							<div class="col-md-12 input-group">	
								<?$download_have_ads=get_modual_setting_result($site,$la,'download_have_ads',$coms_conect);?>
								<input type="checkbox" value="1" <?if($download_have_ads==1) echo 'checked';?>   class="form-control" name="download_have_ads" style="direction: ltr;float: right;width: 16px;margin-top: 0px;">
							</div>					
						</div>
					</div>
					<hr>
					<?$query="select title,link,pic_adress from new_tem_setting where name='download_have_ads'  and la='$la' and site='$site'"; 
						$i=1;
						...
						?>
							...
							<div class="form-group">
								...
								<div class="form-group col-md-9">
									...
									<span class="input-group-btn"><a href="/filemanager/dialog.php?type=1&amp;field_id=image-ads1" class="btn iframe-btn" type="button" >انتخاب</a>
									</div>
								</div>
							</div>
							</div>
...
<!---------------------فایل نمایش------------>
			   <div class="bhoechie-tab-content">
				<!-- #section:download/download_setting.view -->
                    <center>
					<div class="form-group">
							<label class="col-md-3 control-label" for="family">نمايش تبليغات در صفحه اصلي</label> 
						<div class="form-group col-md-9">
							<div class="col-md-12 input-group">	
								<?$download_show_have_ads=get_modual_setting_result($site,$la,'download_show_have_ads',$coms_conect);?>
								<input type="checkbox" value="1" <?if($download_show_have_ads==1) echo 'checked';?>   class="form-control" name="download_show_have_ads" style="direction: ltr;float: right;width: 16px;margin-top: 0px;">
							</div>					
						</div>
					</div>
					<hr>
					<?$query9="select title,link,pic_adress from new_tem_setting where name='download_show_have_ads'  and la='$la' and site='$site'"; 
						$i=1;
						...
						?>
							...
							<div class="form-group">
								...
								<div class="form-group col-md-9">
									...
									<span class="input-group-btn"><a href="/filemanager/dialog.php?type=1&amp;field_id=header_show_pic<?=$i?>" class="btn iframe-btn" type="button" >انتخاب</a>
									</div>
								</div>
							</div>
							</div>
...
<!----------------------------------صفحه دسته بندي------------------------>
			   <div class="bhoechie-tab-content ">
				<!-- #section:download/download_setting.cate -->
                    <center>
					<div class="form-group">
							<label class="col-md-3 control-label" for="family">نمايش تبليغات در صفحه دسته بندي</label> 
						<div class="form-group col-md-9">
							<div class="col-md-12 input-group">	
								<?$download_cat_have_ads=get_modual_setting_result($site,$la,'download_cat_have_ads',$coms_conect);?>
								<input type="checkbox" value="1" <?if($download_cat_have_ads==1) echo 'checked';?>   class="form-control" name="download_cat_have_ads" style="direction: ltr;float: right;width: 16px;margin-top: 0px;">
							</div>					
						</div>
					</div>
										<hr>
					<?$query11="select title,link,pic_adress from new_tem_setting where name='download_cat_have_ads'  and la='$la' and site='$site'"; 
						//echo $query.'<br>';
						$i=1;
						$result11 = $coms_conect->query($query11);
						...
						?>
							...
							<div class="form-group">
								...
								<div class="form-group col-md-9">
									...
									<span class="input-group-btn"><a href="/filemanager/dialog.php?type=1&amp;field_id=image_cat_ads<?=$i?>" class="btn iframe-btn" type="button" >انتخاب</a>
									</div>
								</div>
							</div>
							</div>
...
<!----------------------------------صفحه دسته بندي------------------------>
			   <div class="bhoechie-tab-content ">
				<!-- #section:download/download_setting.search -->
                    <center>
					<div class="form-group">
							<label class="col-md-3 control-label" for="family">نمايش تبليغات در صفحه جستجو</label> 
						<div class="form-group col-md-9">
							<div class="col-md-12 input-group">	
								<?$download_sesrch_have_ads=get_modual_setting_result($site,$la,'download_sesrch_have_ads',$coms_conect);?>
								<input type="checkbox" value="1" <?if($download_sesrch_have_ads==1) echo 'checked';?>   class="form-control" name="download_sesrch_have_ads" style="direction: ltr;float: right;width: 16px;margin-top: 0px;">
							</div>					
						</div>
					</div>
										<hr>
					<?$query11="select title,link,pic_adress from new_tem_setting where name='download_sesrch_have_ads'  and la='$la' and site='$site'"; 
						$i=1;
						$result11 = $coms_conect->query($query11);
						    while($RS11 = $result11->fetch_assoc()) {
							?>
							...
							<div class="form-group">
								...
								<div class="form-group col-md-9">
									...
									<span class="input-group-btn"><a href="/filemanager/dialog.php?type=1&amp;field_id=image_search_ads1" class="btn iframe-btn" type="button" >انتخاب</a>
									</div>
								</div>
							</div>
							</div>
