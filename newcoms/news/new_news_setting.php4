...
####صفحه اصلي
	$news_have_ads=injection_replace_pic($_POST["news_have_ads"]);
	if($news_have_ads!=1) $news_have_ads=0;
	insert_ads_templdate($site,$la,$news_have_ads,'news_have_ads',$coms_conect);
 	$query1="delete from new_tem_setting where name='news_have_ads' and la='$la'"; 
	...
	for($i=1;$i<=$ads_count;$i++){ 
		...
		insert_news_templdate($site,$header_pic,$la,'',$title_ads,$header_link,'',"news_have_ads",'',$coms_conect);
	} 
####فایل نمایش
	$news_show_have_ads=injection_replace_pic($_POST["news_show_have_ads"]);
	if($news_show_have_ads!=1) $news_show_have_ads=0;
	insert_ads_templdate($site,$la,$news_show_have_ads,'news_show_have_ads',$coms_conect);
 	$query1="delete from new_tem_setting where name='news_show_have_ads' and la='$la'"; 
	$coms_conect->query($query1);
	for($i=1;$i<=$ads_show_count;$i++){ 
		...
		insert_news_templdate($site,$header_show_pic,$la,'',$title_show_ads,$header_show_link,'',"news_show_have_ads",'',$coms_conect);
	}	
#######دسته بندي
	$news_cat_have_ads=injection_replace_pic($_POST["news_cat_have_ads"]);
	if($news_cat_have_ads!=1) $news_cat_have_ads=0;
	insert_ads_templdate($site,$la,$news_cat_have_ads,'news_cat_have_ads',$coms_conect);
	$query1="delete from new_tem_setting where name='news_cat_have_ads'  and la='$la'"; 
	$coms_conect->query($query1);
	for($i=1;$i<=$ads_cat_count;$i++){	
		...
		insert_news_templdate($site,$image_cat_ads,$la,'',$title_cat_ads,$link_cat_ads,'',"news_cat_have_ads",'',$coms_conect);
	}

######جستجو	
	$news_sesrch_have_ads=injection_replace_pic($_POST["news_sesrch_have_ads"]);
	if($news_sesrch_have_ads!=1) $news_sesrch_have_ads=0;
	insert_ads_templdate($site,$la,$news_sesrch_have_ads,'news_sesrch_have_ads',$coms_conect);
	$query1="delete from new_tem_setting where name='news_sesrch_have_ads'  and la='$la'"; 
	$coms_conect->query($query1);
	for($i=1;$i<=$ads_search_count;$i++){ 
		...
		insert_news_templdate($site,$image_search_ads,$la,'',$title_search_ads,$link_search_ads,'',"news_sesrch_have_ads",'',$coms_conect);
	}
}
    ...
    <div class="">
	    ...
	    <div class="form-group col-md-12">
			<!-- #section:news/news_setting.default -->
			 <?$news_nav_picture=get_result("select address from new_default_navbar where name='news_nav_picture'  and la='$la' and site='$site'",$coms_conect);?>
			<label class="col-md-3 control-label" for="family">تصویر پیش فرض ناوبری</label>
			<div class="form-group col-md-9">
				<div class="col-md-6 input-group">
				<input type="text" style="direction: ltr;" class="col-md-6"   value="<?=$news_nav_picture?>" data-toggle="popover" id="news_nav_picture" name="news_nav_picture">
				<a href="/filemanager/dialog.php?type=1&amp;field_id=news_nav_picture" class="btn iframe-btn" type="button" style="top: 2px;height: 40px;padding-top: 6px;  float: right;">انتخاب</a>
				</div>
			</div>
			
			 <?$news_pic_size=get_result("select address from new_default_navbar where name='news_pic_size'  and la='fa' and site='main'",$coms_conect);?>
			<label class="col-md-3 control-label" for="family">تنظیمات اندازه تصاویر</label>
			<div class="form-group col-md-9">
				<div class="col-md-5 input-group">
				<input type="text" style="direction: ltr;" class="col-md-6 form-control"    value="<?=$news_pic_size?>"  id="news_pic_size" name="news_pic_size">
            ...
            <div class="col-lg-3 col-md-3 col-sm-3 col-xs-3 bhoechie-tab-menu">
              <div class="list-group">
                <a href="#" class="list-group-item active text-center">
                  تنظيمات خبر صفحه لیست 
                </a>
                <a href="#" class="list-group-item  text-center">
                   تنظيمات خبر صفحه نمایش
                </a> 
                <a href="#" class="list-group-item  text-center">
                   تنظيمات خبر صفحه دسته بندی
                </a> 
                <a href="#" class="list-group-item  text-center">
                   تنظيمات خبر صفحه دسته جستجو
                </a> 
              </div>
            </div>
					...
					<div class="form-group">
						...
						<div class="form-group col-md-9">
							<div class="col-md-12 input-group">	
								<?$news_have_ads=get_modual_setting_result($site,$la,'news_have_ads',$coms_conect);?>
								<input type="checkbox" value="1" <?if($news_have_ads==1) echo 'checked';?>   class="form-control"  name="news_have_ads" style="direction: ltr;float: right;width: 16px;margin-top: 0px;">
							</div>					
						</div>
					</div>
					<hr>
					<?$query="select title,link,pic_adress from new_tem_setting where name='news_have_ads'  and la='$la' and site='$site'"; 
						$i=1;
			   ...
			   <div class="bhoechie-tab-content">
				<!-- #section:news/news_setting.view -->
					...
					<div class="form-group">
						...
						<div class="form-group col-md-9">
							<div class="col-md-12 input-group">	
								<?$news_show_have_ads=get_modual_setting_result($site,$la,'news_show_have_ads',$coms_conect);?>
								<input type="checkbox" value="1" <?if($news_show_have_ads==1) echo 'checked';?>   class="form-control" name="news_show_have_ads" style="direction: ltr;float: right;width: 16px;margin-top: 0px;">
							</div>					
						</div>
					</div>
					<hr>
					<?$query9="select title,link,pic_adress from new_tem_setting where name='news_show_have_ads'  and la='$la' and site='$site'"; 
						$i=1;
...
<!----------------------------------صفحه دسته بندي------------------------>
			   ...
			   <!-- #section:news/news_setting.cate -->
					...
					<div class="form-group">
						...
						<div class="form-group col-md-9">
							<div class="col-md-12 input-group">	
								<?$news_cat_have_ads=get_modual_setting_result($site,$la,'news_cat_have_ads',$coms_conect);?>
								<input type="checkbox" value="1" <?if($news_cat_have_ads==1) echo 'checked';?>   class="form-control" name="news_cat_have_ads" style="direction: ltr;float: right;width: 16px;margin-top: 0px;">
							</div>					
						</div>
					</div>
										<hr>
					<?$query11="select title,link,pic_adress from new_tem_setting where name='news_cat_have_ads'  and la='$la' and site='$site'"; 
						//echo $query.'<br>';
						$i=1;
						$result11 = $coms_conect->query($query11);
...
<!----------------------------------صفحه دسته بندي------------------------>
			   ...
			   <!-- #section:news/news_setting.search -->
					...
					<div class="form-group">
						...
						<div class="form-group col-md-9">
							<div class="col-md-12 input-group">	
								<?$news_sesrch_have_ads=get_modual_setting_result($site,$la,'news_sesrch_have_ads',$coms_conect);?>
								<input type="checkbox" value="1" <?if($news_sesrch_have_ads==1) echo 'checked';?>   class="form-control" name="news_sesrch_have_ads" style="direction: ltr;float: right;width: 16px;margin-top: 0px;">
							</div>					
						</div>
					</div>
										<hr>
					<?$query11="select title,link,pic_adress from new_tem_setting where name='news_sesrch_have_ads'  and la='$la' and site='$site'"; 
						$i=1;
						$result11 = $coms_conect->query($query11);
						    while($RS11 = $result11->fetch_assoc()) {
							?>
