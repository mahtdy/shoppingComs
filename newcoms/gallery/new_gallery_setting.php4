...
if($_POST['send_flag']==1){ 
	...
	#####اندازه تصاویر
	$gallery_pic_size=injection_replace_pic($_POST["gallery_pic_size"]);
	$query11="SELECT id from new_default_navbar where name='gallery_pic_size' and la='fa' and site='main'";
	//echo $query11.'<br>';
	$result11 = $coms_conect->query($query11); 
	$row11 = mysqli_num_rows($result11);
	if ($row11> 0) {
	   $query="update new_default_navbar set address='$gallery_pic_size' where name='gallery_pic_size'  and la='fa'  and site='main'"; 
	   $coms_conect->query($query);
	}else{
     	$query="insert into new_default_navbar(site,address,la,name)values('main','$gallery_pic_size','fa','gallery_pic_size')";
     	$coms_conect->query($query);
	}
	
	#####پیش فرض ناوبری	 
	$gallery_nav_picture=injection_replace_pic($_POST["gallery_nav_picture"]);
	$query11="SELECT id from new_default_navbar where name='gallery_nav_picture' and la='$la' and site='$site'";
	//echo $query11.'<br>';
	$result11 = $coms_conect->query($query11);
	$row11 = mysqli_num_rows($result11);
	if ($row11> 0) {
	   $query="update new_default_navbar set address='$gallery_nav_picture' where name='gallery_nav_picture'  and la='$la'  and site='$site'"; 
	   $coms_conect->query($query);
	}else{
     	$query="insert into new_default_navbar(site,address,la,name)values('$site','$gallery_nav_picture','$la','gallery_nav_picture')";
     	$coms_conect->query($query);
	}
	
	#####پیش واتر مارک
	$gallery_water_mark=injection_replace_pic($_POST["gallery_water_mark"]);
	$query11="SELECT id from new_default_navbar where name='gallery_water_mark' and la='fa' and site='main'";
	//echo $query11.'<br>';
	$result11 = $coms_conect->query($query11); 
	$row11 = mysqli_num_rows($result11);
	if ($row11> 0){	
	   $query="update new_default_navbar set address='$gallery_water_mark' where name='gallery_water_mark'  and la='fa'  and site='main'"; 
	   $coms_conect->query($query);
	}else{
     	$query="insert into new_default_navbar(site,address,la,name)values('main','$gallery_water_mark','fa','gallery_water_mark')";
     	$coms_conect->query($query);
	}	
	
	
####صفحه اصلي
	$gallery_have_ads=injection_replace_pic($_POST["gallery_have_ads"]);
	if($gallery_have_ads!=1) $gallery_have_ads=0;
	insert_ads_templdate($site,$la,$gallery_have_ads,'gallery_have_ads',$coms_conect);
 	$query1="delete from new_tem_setting where name='gallery_have_ads' and la='$la'"; 
	...
	for($i=1;$i<=$ads_count;$i++){ 
		...
		insert_news_templdate($site,$header_pic,$la,'',$title_ads,$header_link,'',"gallery_have_ads",'',$coms_conect);
	} 
####فایل نمایش
	$gallery_show_have_ads=injection_replace_pic($_POST["gallery_show_have_ads"]);
	if($gallery_show_have_ads!=1) $gallery_show_have_ads=0;
	insert_ads_templdate($site,$la,$gallery_show_have_ads,'gallery_show_have_ads',$coms_conect);
 	$query1="delete from new_tem_setting where name='gallery_show_have_ads' and la='$la'"; 
	$coms_conect->query($query1);
	for($i=1;$i<=$ads_show_count;$i++){ 
		...
		insert_news_templdate($site,$header_show_pic,$la,'',$title_show_ads,$header_show_link,'',"gallery_show_have_ads",'',$coms_conect);
	}	
#######دسته بندي
	$gallery_cat_have_ads=injection_replace_pic($_POST["gallery_cat_have_ads"]);
	if($gallery_cat_have_ads!=1) $gallery_cat_have_ads=0;
	insert_ads_templdate($site,$la,$gallery_cat_have_ads,'gallery_cat_have_ads',$coms_conect);
	$query1="delete from new_tem_setting where name='gallery_cat_have_ads' and la='$la'"; 
	$coms_conect->query($query1);
	for($i=1;$i<=$ads_cat_count;$i++){	
		...
		insert_news_templdate($site,$image_cat_ads,$la,'',$title_cat_ads,$link_cat_ads,'',"gallery_cat_have_ads",'',$coms_conect);
	}

######جستجو	
	$gallery_sesrch_have_ads=injection_replace_pic($_POST["gallery_sesrch_have_ads"]);
	if($gallery_sesrch_have_ads!=1) $gallery_sesrch_have_ads=0;
	insert_ads_templdate($site,$la,$gallery_sesrch_have_ads,'gallery_sesrch_have_ads',$coms_conect);
	$query1="delete from new_tem_setting where name='gallery_sesrch_have_ads' and la='$la'"; 
	$coms_conect->query($query1);
	for($i=1;$i<=$ads_search_count;$i++){ 
		...
		insert_news_templdate($site,$image_search_ads,$la,'',$title_search_ads,$link_search_ads,'',"gallery_sesrch_have_ads",'',$coms_conect);
	}
}
...
<div class="title"><p class="titr">تنظيمات گالری تصاویر</p><p class="lead">توضيحات اين بخش</p></div>
</div>
<!-- /section:gallery/gallery_setting.head -->
    ...
    <div class="">
		...
		<div class="container">
			...
			<label>   انتخاب زبان     </label>	
								...
								<select id="manage_lang_filter" name="manage_lang_filter" class="form-group col-md-12">
		...
		<hr>
		 <div class="form-group col-md-12">
			<!-- #section:gallery/gallery_setting.default -->
			 <?$gallery_nav_picture=get_result("select address from new_default_navbar where name='gallery_nav_picture'  and la='$la' and site='$site'",$coms_conect);?>
			<label class="col-md-3 control-label" for="family">تصویر پیش فرض ناوبری</label>
			<div class="form-group col-md-9">
				<div class="col-md-6 input-group">
				<input type="text" style="direction: ltr;" class="col-md-6 form-control" data-toggle="popover"   value="<?=$gallery_nav_picture?>"  id="gallery_nav_picture" name="gallery_nav_picture">
				<span class="input-group-btn"><a href="/filemanager/dialog.php?type=1&amp;field_id=gallery_nav_picture" class="btn iframe-btn" type="button" >انتخاب</a></span>
				</div>
			</div>
			
			<!-- #section:gallery/gallery_setting.default -->
			 <?$gallery_water_mark=get_result("select address from new_default_navbar where name='gallery_water_mark'  and la='fa' and site='main'",$coms_conect);?>
			<label class="col-md-3 control-label" for="family">تصویر واتر مارکُ</label>
			<div class="form-group col-md-9">
				<div class="col-md-6 input-group">
				<input type="text" style="direction: ltr;" class="col-md-6 form-control" data-toggle="popover"   value="<?=$gallery_water_mark?>"  id="gallery_water_mark" name="gallery_water_mark">
				<span class="input-group-btn"><a href="/filemanager/dialog.php?type=1&amp;field_id=gallery_water_mark" class="btn iframe-btn" type="button" >انتخاب</a></span>
				</div>
			</div>
			
			<?$gallery_pic_size=get_result("select address from new_default_navbar where name='gallery_pic_size'  and la='fa' and site='main'",$coms_conect);?>
			<label class="col-md-3 control-label" for="family">تنظیمات اندازه تصاویر</label>
			<div class="form-group col-md-9">
				<div class="col-md-6 input-group">
				<input type="text" style="direction: ltr;" class="col-md-6 form-control"    value="<?=$gallery_pic_size?>"  id="gallery_pic_size" name="gallery_pic_size">
			 	</div>
			</div>
			<hr>

			<?/*$ftp_setting= get_tem_result($site,$la,"ftp_setting",'defualt',$coms_conect);?>	
			<label class="col-md-3 control-label" for="family">Ip سرور</label>
			<div class="form-group col-md-9">
				<div class="col-md-6 input-group">
				<input type="text" style="direction: ltr;" class="col-md-6 form-control"    value="<?=$ftp_setting['text']?>"  id="ftp_ip" name="ftp_ip">
			 	</div>
			</div>
			<label class="col-md-3 control-label" for="family">آدرس ftp</label>
			<div class="form-group col-md-9">
				<div class="col-md-6 input-group">
				<input type="text" style="direction: ltr;" class="col-md-6 form-control"    value="<?=$ftp_setting['pic']?>"  id="ftp_adress" name="ftp_adress">
			 	</div>
			</div>
						<label class="col-md-3 control-label" for="family">نام کاربری</label>
			<div class="form-group col-md-9">
				<div class="col-md-6 input-group">
			...
			<label class="col-md-3 control-label" for="family">کلمه عبور</label>
			<div class="form-group col-md-9">
				<div class="col-md-6 input-group">
            ...
            <div class="col-lg-3 col-md-3 col-sm-3 col-xs-3 bhoechie-tab-menu">
              <div class="list-group">
                <a href="#" class="list-group-item active text-center">
                  تنظيمات گالری تصاویر صفحه لیست 
                </a>
                <a href="#" class="list-group-item  text-center">
                   تنظيمات گالری تصاویر صفحه نمایش
                </a> 
                <a href="#" class="list-group-item  text-center">
                   تنظيمات گالری تصاویر صفحه دسته بندی
                </a> 
                <a href="#" class="list-group-item  text-center">
                   تنظيمات گالری تصاویر صفحه دسته جستجو
                </a> 
              </div>
            </div>
...
<!---------------------new_modual_tem_setting-------------تماس با ما هدر------------>
			   ...
			   <!-- #section:gallery/gallery_setting.list -->
                    <center>
					<div class="form-group">
							<label class="col-md-3 control-label" for="family">نمايش تبليغات در صفحه اصلی</label> 
						<div class="form-group col-md-9">
							<div class="col-md-12 input-group">	
								<?$gallery_have_ads=get_modual_setting_result($site,$la,'gallery_have_ads',$coms_conect);?>
								<input type="checkbox" value="1" <?if($gallery_have_ads==1) echo 'checked';?>   class="form-control" name="gallery_have_ads" style="direction: ltr;float: right;width: 16px;margin-top: 0px;">
							</div>					
						</div>
					</div>
					<hr>
					<?$query="select title,link,pic_adress from new_tem_setting where name='gallery_have_ads'  and la='$la' and site='$site'"; 
						$i=1;
						$result = $coms_conect->query($query);
...
<!---------------------فایل نمایش------------>
			   ...
			   <!-- #section:gallery/gallery_setting.view -->
                    <center>
					<div class="form-group">
							<label class="col-md-3 control-label" for="family">نمايش تبليغات در صفحه اصلی</label> 
						<div class="form-group col-md-9">
							<div class="col-md-12 input-group">	
								<?$gallery_show_have_ads=get_modual_setting_result($site,$la,'gallery_show_have_ads',$coms_conect);?>
								<input type="checkbox" value="1" <?if($gallery_show_have_ads==1) echo 'checked';?>   class="form-control" name="gallery_show_have_ads" style="direction: ltr;float: right;width: 16px;margin-top: 0px;">
							</div>					
						</div>
					</div>
					<hr>
					<?$query9="select title,link,pic_adress from new_tem_setting where name='gallery_show_have_ads'  and la='$la' and site='$site'"; 
						$i=1;
...
<!----------------------------------صفحه دسته بندي------------------------>
			   <div class="bhoechie-tab-content ">
			   <!-- #section:gallery/gallery_setting.cate -->
                    <center>
					<div class="form-group">
							<label class="col-md-3 control-label" for="family">نمايش تبليغات در صفحه دسته بندی</label> 
						<div class="form-group col-md-9">
							<div class="col-md-12 input-group">	
								<?$gallery_cat_have_ads=get_modual_setting_result($site,$la,'gallery_cat_have_ads',$coms_conect);?>
								<input type="checkbox" value="1" <?if($gallery_cat_have_ads==1) echo 'checked';?>   class="form-control" name="gallery_cat_have_ads" style="direction: ltr;float: right;width: 16px;margin-top: 0px;">
							</div>					
						</div>
					</div>
										<hr>
					<?$query11="select title,link,pic_adress from new_tem_setting where name='gallery_cat_have_ads'  and la='$la' and site='$site'"; 
						//echo $query.'<br>';
						$i=1;
						$result11 = $coms_conect->query($query11);
...
<!----------------------------------صفحه دسته بندي------------------------>
			   <div class="bhoechie-tab-content ">
			   <!-- #section:gallery/gallery_setting.search -->
                    <center>
					<div class="form-group">
							<label class="col-md-3 control-label" for="family">نمايش تبليغات در صفحه جستجو</label> 
						<div class="form-group col-md-9">
							<div class="col-md-12 input-group">	
								<?$gallery_sesrch_have_ads=get_modual_setting_result($site,$la,'gallery_sesrch_have_ads',$coms_conect);?>
								<input type="checkbox" value="1" <?if($gallery_sesrch_have_ads==1) echo 'checked';?>   class="form-control" name="gallery_sesrch_have_ads" style="direction: ltr;float: right;width: 16px;margin-top: 0px;">
							</div>					
						</div>
					</div>
										<hr>
					<?$query11="select title,link,pic_adress from new_tem_setting where name='gallery_sesrch_have_ads'  and la='$la' and site='$site'"; 
						$i=1;
						$result11 = $coms_conect->query($query11);
						    while($RS11 = $result11->fetch_assoc()) {
							?>
