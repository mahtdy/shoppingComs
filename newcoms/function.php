...
function get_pic_seo($url,$site,$la,$coms_conect){

    ##----------------------Jarahan--------------
    if ($url=='rhinoplasty'){
        return get_result("select pic_adress from new_tem_setting where name='rhinoplasty_header_seo' and la='$la' and site='$site' and tem_name='Jarahan'",$coms_conect);
    }
    if ($url=='bony_nose_surgery'){
        return get_result("select pic_adress from new_tem_setting where name='bony_nose_surgery_header_seo' and la='$la' and site='$site' and tem_name='Jarahan'",$coms_conect);
    } 
    if ($url=='otoplasty'){
        return get_result("select pic_adress from new_tem_setting where name='otoplasty_header_seo' and la='$la' and site='$site' and tem_name='Jarahan'",$coms_conect);
    }
    ##----------------------Medirence2--------------
    if ($url=='products'){
        return get_result("select pic_adress from new_tem_setting where name='products_header_seo' and la='$la' and site='$site' and tem_name='Medirence2'",$coms_conect);
    }
    if ($url=='category'){
        return get_result("select pic_adress from new_tem_setting where name='category_header_seo' and la='$la' and site='$site' and tem_name='Medirence2'",$coms_conect);
    }

    ##----------------------End Medirence2--------------
    if ($url=='content'){
        return get_result("select pic_adress from new_tem_setting where name='content_header_seo' and la='$la' and site='$site' and tem_name='coms2'",$coms_conect);
    }
    if ($url=='android_app_development'){
        return get_result("select pic_adress from new_tem_setting where name='android_app_development_header_seo' and la='$la' and site='$site' and tem_name='coms2'",$coms_conect);
    }
    if ($url=='ios_app_development'){
        return get_result("select pic_adress from new_tem_setting where name='ios_app_development_header_seo' and la='$la' and site='$site' and tem_name='coms2'",$coms_conect);
    }
    if ($url=='startup'){
        return get_result("select pic_adress from new_tem_setting where name='startup_header_seo' and la='$la' and site='$site' and tem_name='coms2'",$coms_conect);
    }
    if ($url=='dedicatedserver_nvme'){
        return get_result("select pic_adress from new_tem_setting where name='dedicatedserver_nvme_header_seo' and la='$la' and site='$site' and tem_name='coms2'",$coms_conect);
    }
    if ($url=='android'){
        return get_result("select pic_adress from new_tem_setting where name='android_header_seo' and la='$la' and site='$site' and tem_name='coms2'",$coms_conect);
    }
    if ($url=='webpack'){
        return get_result("select pic_adress from new_tem_setting where name='webpack_header_seo' and la='$la' and site='$site' and tem_name='coms2'",$coms_conect);
    }
    if ($url=='education'){
        return get_result("select pic_adress from new_tem_setting where name='education_header_seo' and la='$la' and site='$site' and tem_name='coms2'",$coms_conect);
    }
    if ($url=='host'){
        return get_result("select pic_adress from new_tem_setting where name='host_header_seo' and la='$la' and site='$site' and tem_name='coms2'",$coms_conect);
    }
    if ($url=='intohost'){
        return get_result("select pic_adress from new_tem_setting where name='intohost_header_seo' and la='$la' and site='$site' and tem_name='coms2'",$coms_conect);
    }
    if ($url=='domain'){
        return get_result("select pic_adress from new_tem_setting where name='domain_header_seo' and la='$la' and site='$site' and tem_name='coms2'",$coms_conect);
    }
    if ($url=='dedicated'){
        return get_result("select pic_adress from new_tem_setting where name='dedicated_header_seo' and la='$la' and site='$site' and tem_name='coms2'",$coms_conect);
    }
    if ($url=='dedicated_server'){
        return get_result("select pic_adress from new_tem_setting where name='dedicated_server_header_seo' and la='$la' and site='$site' and tem_name='coms2'",$coms_conect);
    }
    if ($url=='license'){
        return get_result("select pic_adress from new_tem_setting where name='license_header_seo' and la='$la' and site='$site' and tem_name='coms2'",$coms_conect);
    }
    if ($url=='adwords'){
        return get_result("select pic_adress from new_tem_setting where name='adwords_header_seo' and la='$la' and site='$site' and tem_name='coms2'",$coms_conect);
    }
    if ($url=='sms'){
        return get_result("select pic_adress from new_tem_setting where name='sms_header_seo' and la='$la' and site='$site' and tem_name='coms2'",$coms_conect);
    }
    if ($url=='ssl'){
        return get_result("select pic_adress from new_tem_setting where name='ssl_header_seo' and la='$la' and site='$site' and tem_name='coms2'",$coms_conect);
    }
    if ($url=='vps'){
        return get_result("select pic_adress from new_tem_setting where name='vps_header_seo' and la='$la' and site='$site' and tem_name='coms2'",$coms_conect);
    }
    if ($url=='about'){
        return get_result("select pic_adress from new_tem_setting where name='about_header_seo' and la='$la' and site='$site' and tem_name='coms2'",$coms_conect);
    }
...
function show_madules_cat($parentID,$site_id,$la,$type,$coms_conect,$modul_name='news') {
    ...
    if ($result->num_rows > 0) {
        ...
        while($row = $result->fetch_assoc()) {
            ...
            echo '	<div class="pull-right action-buttons">';
            if ($type==4)echo '<a href="newcoms.php?yep=new_product_cat_nazar&catid='.$row['id'].'" class="btn " style="background:orange!important;" role="button">'.'عناوین نظر سنجی'.'</a><a href="newcoms.php?yep=new_product_cat_cat&catid='.$row['id'].'&catof='.'1'.'" class="btn " style="background:red!important;" role="button">'.'فیلترینگ جستجو'.'</a><a href="newcoms.php?yep=new_product_cat_barrasi&catid='.$row['id'].'&barrof='.'3'.'" class="btn btn-info" style="background:green!important;" role="button">'.'بررسی تخصصی'.'</a><a href="newcoms.php?yep=new_product_cat_cat&catid='.$row['id'].'&catof='.'0'.'" class="btn btn-info" role="button">'.'دسته بندی فیلدها'.'</a><a href="newcoms.php?yep=new_product_fields&cat_id='.$row['id'].'" class="btn " role="button">'.'افزودن فیلد ویژگی ها'.'</a>';
            ...
            if($type==100&&menu_has_child($id,$coms_conect)==0&&$_SESSION["can_delete"]==1){
            ...
            else if($type!=100&&menu_has_child($id,$coms_conect)==0&&$_SESSION["can_delete"]==1){
                echo '<a id='.$id.' class="del_menu red" data-title="Delete" data-toggle="modal" data-target="#delete" data-placement="top" rel="tooltip">
										<span class="flaticon-delete84 bigger-130"></span>
										</a>';
            }
...
//###############################################################
//function creat_madual_cat_permission($id,$edit_id,$arr,$manager_group,$type,$coms_conect,$la){
//    $sql = "SELECT id,name,parent_id FROM new_modules_cat a ,new_cat_permission b WHERE
//			parent_id='$id' and type='$type' and permission=1 and a.id=b.menu_id and a.status=1 and la='$la' and b.group_id=$manager_group group by    a.id ORDER BY type ";
////    echo $sql;exit;
//    $result = $coms_conect->query($sql);
//    echo ",'children': [";
...
////         if(($edit_id>""&&in_array($row['id'],$arr))||($j==1&&$edit_id==""))
//        $str =",'state': { 'opened': true ,";
////        if($row['parent_id']>'0') echo $row['parent_id'];
////            $str.="";
////        $str.= $row['parent_id'];
////        echo $str;
//         if($edit_id>""&&in_array($row['id'],$arr))
...
function insert_templdate_menu_Tabs($site,$pic_adress,$la,$text,$i,$link,$pic,$name,$id_Tabs,$coms_conect,$type=0){
    $query11="SELECT id from new_tem_setting where name='$name' and la='$la' and site='$site' and tem_name='$id_Tabs'";
//    if($type==1)
//        echo $query11.'<br>';
    $result11 = $coms_conect->query($query11);
    $row11 = mysqli_num_rows($result11);
    if ($row11> 0) {
        $query="update new_tem_setting set pic_adress='$pic_adress',title='$i',link='$link',pic='$pic',text='".$text."' where name='$name' and tem_name='$id_Tabs' and la='$la'  and site='$site'";
        //if($name=='google_code_analiz')
        if($type==1)
            echo $query;
        $coms_conect->query($query);
    }else{
        $query="insert into new_tem_setting(site,pic_adress,la,title,link,pic,text,name,tem_name)values('$site','$pic_adress','$la','$i','$link','$pic','$text','$name','$id_Tabs')";
        if($type==1)
            echo $query;
        $coms_conect->query($query);
...
function update_templdate_tabs($site,$pic_adress,$la,$text,$title,$link,$pic,$name,$tem_name,$coms_conect,$type=0){
...
function insert_templdate_tabs($site,$pic_adress,$la,$text,$title,$link,$pic,$name,$tem_name,$coms_conect,$type=0){
...
//this is for insert in tabs menu
function insert_templdate_Tabs_new($site,$pic_adress,$la,$text,$id_Tabs ,$link,$pic,$name,$tem_name,$coms_conect,$type=0)
{

    $query="insert into new_menu_tabs_shop(site,number,la,title,link,id_modules,filter_show,name,show_name)values('$site','$pic_adress','$la','$id_Tabs','$link','$pic','$text','$name','$tem_name')";
    if($type==1)
        echo $query;
    $coms_conect->query($query);
}

function update_templdate_Tabs_new($site,$pic_adress,$la,$text,$edit_id ,$link,$pic,$name,$tem_name,$coms_conect,$type=0)
{
    $query="update new_menu_tabs_shop set show_name='$tem_name',number='$pic_adress',title='$edit_id',link='$link',id_modules='$pic',filter_show='".$text."' where title='$edit_id'";
    if($type==1)
        echo $query;
    $coms_conect->query($query);
    echo $query;
...
function get_tem_result_Tabs($site,$la,$name,$tem,$coms_conect){
    $query="select * from new_tem_setting where name='$name' and tem_name='$tem' and la='$la' and site='$site' ";
    //echo $query;
    $result = $coms_conect->query($query);
    $RS = $result->fetch_assoc();
    $arr = array("text"=>$RS["text"], "title"=>$RS["title"], "pic"=>$RS["pic"], "link"=>$RS["link"], "pic_adress"=>$RS["pic_adress"] , "la"=>$RS["la"]);
    return $arr;

}
//end code for menu Tabs menu



function insert_templdate_menubar($site,$pic_adress,$la,$text,$id_shop ,$link,$pic,$name,$tem_name,$coms_conect,$type=0)
{

    $query="insert into new_menu_tabs_shop(site,number,la,title,link,id_modules,filter_show,name,show_name)values('$site','$pic_adress','$la','$id_shop','$link','$pic','$text','$name','$tem_name')";
    if($type==1)
        echo $query;
    $coms_conect->query($query);
}

function update_templdate_menubar($site,$pic_adress,$la,$text,$edit_id ,$link,$pic,$name,$tem_name,$coms_conect,$type=0)
{
    $query="update new_menu_tabs_shop set show_name='$tem_name',number='$pic_adress',title='$edit_id',link='$link',id_modules='$pic',filter_show='".$text."' where title='$edit_id'";
    if($type==1)
        echo $query;
...
function send_sms_new($sms_value,$mobile,$coms_conect)
{
    $curl = curl_init();
    ...
    curl_setopt_array($curl, array(
        ...
        CURLOPT_POSTFIELDS => "message=hi masoud error for api $rndcode  aparat $sms_value  &sender=10008642&Receptor=09358703534&=",
        CURLOPT_HTTPHEADER => array(
            "apikey: bb9k1ZqvVGVHImXX66V4/qZj5tDesoAN1XrdQOyat6U",
        ),
    ));
...
//    print_r($response);
    ...
    if ($err) {
        echo "cURL Error #:" . $err.'hasan';
    } else {
        $condition='mobile='.$mobile;$arr=array("sms_code"=>$rndcode);
        update_data_base($arr, 'new_members', $condition, $coms_conect);
        $arr_succs=array("result"=>1,"rndcode"=>$rndcode);
//        echo $response.'*'.$rndcode;
          return  $arr_succs;
    }
}
...
function get_result_array_fild($fild,$sql,$coms_conect,$type=0){
    if($type==1)
        echo $sql.'<br>'.$fild;
    $result = $coms_conect->query($sql);
    while($row = $result->fetch_assoc()){
...
function get_result_Tabs($sql,$coms_conect,$type=0){
    if($type==1)
        echo $sql.'<br>';
    $result=mysqli_query($coms_conect,$sql);
    $row =mysqli_fetch_array($result,MYSQLI_NUM);
...
function create_label_pishgaman($value,$madual,$la,$coms_conect,$type){
    ...
    while($row = $result->fetch_assoc()) {
        $name=$row['name'];
        $label .=" <li> <a itemprop='keywords' target=_blank href='/$madual/$la/keyword/".insert_dash($name)."/1'>$name</a>  </li>";
    }
    echo $label;
}
...
function get_meta_descripton($site,$la,$madual_id,$modual,$coms_conect,$madual_cat_id,$tem_name){
    ...
    ##----------------------jarahan--------------
    if($modual=='rhinoplasty'){
        return get_result("select text from new_tem_setting where name='rhinoplasty_header_seo' and la='$la' and site='$site' and tem_name='Jarahan'",$coms_conect);
    }
    if($modual=='bony_nose_surgery'){
        return get_result("select text from new_tem_setting where name='bony_nose_surgery_header_seo' and la='$la' and site='$site' and tem_name='Jarahan'",$coms_conect);
    }
    if($modual=='otoplasty'){
        return get_result("select text from new_tem_setting where name='otoplasty_header_seo' and la='$la' and site='$site' and tem_name='Jarahan'",$coms_conect);
    }
    ##----------------------Medirence2--------------
    ##products
    if($modual=='products'){
        return get_result("select text from new_tem_setting where name='products_header_seo' and la='$la' and site='$site' and tem_name='Medirence2'",$coms_conect);
    }
    ##category
    if($modual=='category'){
        return get_result("select text from new_tem_setting where name='category_header_seo' and la='$la' and site='$site' and tem_name='Medirence2'",$coms_conect);
    }
    ##under_cat

    ##----------------------End Medirence2--------------
    ##ios-app-development
    if($modual=='ios-app-development'){
        return get_result("select text from new_tem_setting where name='ios_app_development_header_seo' and la='$la' and site='$site' and tem_name='coms2'",$coms_conect);
    }
    ##startup
    if($modual=='startup'){
        return get_result("select text from new_tem_setting where name='startup_header_seo' and la='$la' and site='$site' and tem_name='coms2'",$coms_conect);
    }
    ##dedicatedserver_nvme
    if($modual=='dedicatedserver_nvme'){
        return get_result("select text from new_tem_setting where name='dedicatedserver_nvme_header_seo' and la='$la' and site='$site' and tem_name='coms2'",$coms_conect);
    }
    ##android
    if($modual=='android'){
        return get_result("select text from new_tem_setting where name='android_header_seo' and la='$la' and site='$site' and tem_name='coms2'",$coms_conect);
    }
    ##webpack
    if($modual=='webpack'){
        return get_result("select text from new_tem_setting where name='webpack_header_seo' and la='$la' and site='$site' and tem_name='coms2'",$coms_conect);
    }
    ##education
    if($modual=='education'){
        return get_result("select text from new_tem_setting where name='education_header_seo' and la='$la' and site='$site' and tem_name='coms2'",$coms_conect);
    }
    ##host
    if($modual=='host'){
        return get_result("select text from new_tem_setting where name='host_header_seo' and la='$la' and site='$site' and tem_name='coms2'",$coms_conect);
    }
    ##intohost
    if($modual=='intohost'){
        return get_result("select text from new_tem_setting where name='intohost_header_seo' and la='$la' and site='$site' and tem_name='coms2'",$coms_conect);
    }
    ##domain
    if($modual=='domain'){
        return get_result("select text from new_tem_setting where name='domain_header_seo' and la='$la' and site='$site' and tem_name='coms2'",$coms_conect);
    }
    ##dedicated
    if($modual=='dedicated'){
        return get_result("select text from new_tem_setting where name='dedicated_header_seo' and la='$la' and site='$site' and tem_name='coms2'",$coms_conect);
    }
    ##dedicated_server
    if($modual=='dedicated_server'){
        return get_result("select text from new_tem_setting where name='dedicated_server_header_seo' and la='$la' and site='$site' and tem_name='coms2'",$coms_conect);
    }
    ##license
    if($modual=='license'){
        return get_result("select text from new_tem_setting where name='license_header_seo' and la='$la' and site='$site' and tem_name='coms2'",$coms_conect);
    }
    ##adwords
    if($modual=='adwords'){
        return get_result("select text from new_tem_setting where name='adwords_header_seo' and la='$la' and site='$site' and tem_name='coms2'",$coms_conect);
    }
    ##sms
    if($modual=='sms'){
        return get_result("select text from new_tem_setting where name='sms_header_seo' and la='$la' and site='$site' and tem_name='coms2'",$coms_conect);
    }
    ##ssl
    if($modual=='ssl'){
        return get_result("select text from new_tem_setting where name='ssl_header_seo' and la='$la' and site='$site' and tem_name='coms2'",$coms_conect);
    }
    ##vps
    if($modual=='vps'){
        return get_result("select text from new_tem_setting where name='vps_header_seo' and la='$la' and site='$site' and tem_name='coms2'",$coms_conect);
    }
    ##about
    if($modual=='about'){
        return get_result("select text from new_tem_setting where name='about_header_seo' and la='$la' and site='$site' and tem_name='coms2'",$coms_conect);
    }
    ...
    if($modual=='company'&&$madual_id>0){
        $table='new_company';$str="and site='$site'";$meta_desciption_id=$madual_id;
    }else
        if($modual=='company'&&$madual_cat_id>0){
            $table='new_modules_cat';$meta_desciption_id=$madual_cat_id;
        }
...
function get_meta_keyword($site,$la,$madual_id,$modual,$coms_conect,$madual_cat_id,$tem_name){
    ...
    ##----------------------jarahan--------------
    if($modual=='rhinoplasty'){
        return get_result("select title from new_tem_setting where name='rhinoplasty_header_seo' and la='$la' and site='$site' and tem_name='Jarahan'",$coms_conect);
    }
    if($modual=='bony_nose_surgery'){
        return get_result("select title from new_tem_setting where name='bony_nose_surgery_header_seo' and la='$la' and site='$site' and tem_name='Jarahan'",$coms_conect);
    }
    if($modual=='otoplasty'){
        return get_result("select title from new_tem_setting where name='otoplasty_header_seo' and la='$la' and site='$site' and tem_name='Jarahan'",$coms_conect);
    }
    ##----------------------Medirence2--------------
    ##products
    if($modual=='products'){
        return get_result("select title from new_tem_setting where name='products_header_seo' and la='$la' and site='$site' and tem_name='Medirence2'",$coms_conect);
    }
    ##category
    if($modual=='category'){
        return get_result("select title from new_tem_setting where name='category_header_seo' and la='$la' and site='$site' and tem_name='Medirence2'",$coms_conect);
    }
    ##under_cat

    ##----------------------End Medirence2--------------
    ##android-app-development
    if($modual=='android-app-development'){
        return get_result("select title from new_tem_setting where name='android_app_development_header_seo' and la='$la' and site='$site' and tem_name='coms2'",$coms_conect);
    }
    ##ios-app-development
    if($modual=='ios-app-development'){
        return get_result("select title from new_tem_setting where name='ios_app_development_header_seo' and la='$la' and site='$site' and tem_name='coms2'",$coms_conect);
    }
    ##startup
    if($modual=='startup'){
        return get_result("select title from new_tem_setting where name='startup_header_seo' and la='$la' and site='$site' and tem_name='coms2'",$coms_conect);
    }
    ##dedicatedserver_nvme
    if($modual=='dedicatedserver_nvme'){
        return get_result("select title from new_tem_setting where name='dedicatedserver_nvme_header_seo' and la='$la' and site='$site' and tem_name='coms2'",$coms_conect);
    }
    ##android
    if($modual=='android'){
        return get_result("select title from new_tem_setting where name='android_header_seo' and la='$la' and site='$site' and tem_name='coms2'",$coms_conect);
    }
    ##webpack
    if($modual=='webpack'){
        return get_result("select title from new_tem_setting where name='webpack_header_seo' and la='$la' and site='$site' and tem_name='coms2'",$coms_conect);
    }
    ##education
    if($modual=='education'){
        return get_result("select title from new_tem_setting where name='education_header_seo' and la='$la' and site='$site' and tem_name='coms2'",$coms_conect);
    }
    ##host
    if($modual=='host'){
        return get_result("select title from new_tem_setting where name='host_header_seo' and la='$la' and site='$site' and tem_name='coms2'",$coms_conect);
    }
    ##intohost
    if($modual=='intohost'){
        return get_result("select title from new_tem_setting where name='intohost_header_seo' and la='$la' and site='$site' and tem_name='coms2'",$coms_conect);
    }
    ##domain
    if($modual=='domain'){
        return get_result("select title from new_tem_setting where name='domain_header_seo' and la='$la' and site='$site' and tem_name='coms2'",$coms_conect);
    }
    ##dedicated
    if($modual=='dedicated'){
        return get_result("select title from new_tem_setting where name='dedicated_header_seo' and la='$la' and site='$site' and tem_name='coms2'",$coms_conect);
    }
    ##dedicated_server
    if($modual=='dedicated_server'){
        return get_result("select title from new_tem_setting where name='dedicated_server_header_seo' and la='$la' and site='$site' and tem_name='coms2'",$coms_conect);
    }
    ##license
    if($modual=='license'){
        return get_result("select title from new_tem_setting where name='license_header_seo' and la='$la' and site='$site' and tem_name='coms2'",$coms_conect);
    }
    ##adwords
    if($modual=='adwords'){
        return get_result("select title from new_tem_setting where name='adwords_header_seo' and la='$la' and site='$site' and tem_name='coms2'",$coms_conect);
    }
    ##sms
    if($modual=='sms'){
        return get_result("select title from new_tem_setting where name='sms_header_seo' and la='$la' and site='$site' and tem_name='coms2'",$coms_conect);
    }
    ##ssl
    if($modual=='ssl'){
        return get_result("select title from new_tem_setting where name='ssl_header_seo' and la='$la' and site='$site' and tem_name='coms2'",$coms_conect);
    }
    ##vps
    if($modual=='vps'){
        return get_result("select title from new_tem_setting where name='vps_header_seo' and la='$la' and site='$site' and tem_name='coms2'",$coms_conect);
    }
    ##about
    if($modual=='about'){
        return get_result("select title from new_tem_setting where name='about_header_seo' and la='$la' and site='$site' and tem_name='coms2'",$coms_conect);
    }
##news
    if($modual=='news'&&$madual_id>0){
...
##company
        ...
        $table='new_company';$str="and site='$site'";$meta_keyword_id=$madual_id;
    }else if($modual=='company'&&$madual_cat_id>0){
        $table='new_modules_cat';$meta_keyword_id=$madual_cat_id;
...
function insert_templdate_page($id_page,$input_type,$site,$pic_adress,$la,$text,$title,$link,$pic,$name,$tem_name,$coms_conect,$type=0){
    $query11="SELECT id from new_static_page_setting where id_page='$id_page' and la='$la' and site='$site'";
//echo $query11;
    $result11 = $coms_conect->query($query11);
    $row11 = mysqli_num_rows($result11);
    //echo $row11;
//    if ($row11> 0) {
//        $query="update new_static_page_setting set  pic_adress='$pic_adress',title='$title',link='$link',pic='$pic',text='".$text."' where id_page='$id_page'  and la='$la'  and site='$site'";
//        //if($name=='google_code_analiz')
//        if($type==1)
//            echo $query;
//        $coms_conect->query($query);
//    }else{
        $query="insert into new_static_page_setting(input_type,id_page,site,pic_adress,la,title,link,pic,text,name,tem_name)values('$input_type','$id_page','$site','$pic_adress','$la','$title','$link','$pic','$text','$name','$tem_name')";
        //  echo $query;
        if($type==1)
            echo $query;
        $coms_conect->query($query);
...
function get_tem_result_page($site,$la,$name,$tem_name,$coms_conect){
    $query="select * from new_static_page_setting where input_type like '$name' and id_page='$tem_name' and la='$la' and site='$site'";
//    echo $query;
    $result = $coms_conect->query($query);

    $RS = $result->fetch_assoc();
    $arr = array("name"=>$RS["name"],"text"=>$RS["text"], "title"=>$RS["title"], "pic"=>$RS["pic"], "link"=>$RS["link"], "pic_adress"=>$RS["pic_adress"]);
    return $arr;
}

function get_tem_result_page_plus($site,$la,$name,$tem_name,$coms_conect){
    $query="select * from new_static_page_setting where name like '$name%' and id_page='$tem_name' and la='$la' and site='$site'";
//    echo $query;
    $result = $coms_conect->query($query);
...
function resize_image_M($src_file, $w, $h,$dst_file,$quality) {
    ...
    if ($src_file !=''){
        if (strstr($src_file,'https://')==true) {
            $ww1='https://' . $_SERVER["HTTP_HOST"].'/';
        }else{
...
//        echo $ww1;
        ...
        if (getimagesize($src_file)==false){
            $src_file="yep_theme/img/User-icon.png";
        }
        ...
        if ($dst_file == '') {
            ...
            preg_match('/[a-zA-z0-9-_ ()]{1,}(.png|.jpg|.jpeg|.gif)$/i', $src_file, $match);
            $name_match = $match[0];
            if (file_exists($dst_file . $name_match)){
                $dst_file = $dst_file . $name_match;
            }else{
                // print_r($name_match);
...
//        echo $width.$check[0];
            if ($width != $check[0] && $height != $check[1]) {
                $rp_src = resize_image_M($str_rp1, $width, $height, $dst_file, '');
...
//=======mahtdy===
function get_seo_title($site,$la,$madual_id,$modual,$coms_conect,$madual_cat_id,$tem_name){

##company
    if($modual=='company'&&$madual_id>0){
        $table='new_company';$str="and site='$site'";$seo_title_id=$madual_id;
    }else if($modual=='company'&&$madual_cat_id>0){
        $table='new_modules_cat';$seo_title_id=$madual_cat_id;
    }else if($madual_id>""){
        $table='new_static_page'; $str="and site='$site'";
        return get_result("select seo_title from $table where id='$madual_id' and la='$la' $str",$coms_conect);
    }/*else if($modual=='page'&&$madual_cat_id>0){
		$table='new_static_page';$meta_keyword_id=$madual_cat_id;
	}	*/

    if($table){
        $temp= get_result("select seo_title from $table where id=$seo_title_id and la='$la' $str",$coms_conect);
        if($temp>"")
            return $temp;
    }
    if($temp=='')
...
function get_ctlg_result($la,$edit_id,$coms_conect){
    $query="select * from new_company_catalog where  id_com='$edit_id' and la='$la' ";
//    echo '<br>'.$query.'<br>';
    $result = $coms_conect->query($query);
//    echo '<br>';print_r($result);
    $i=0;
    while ( $RS = $result->fetch_assoc()){
//    echo '<br>'.'=w= ';print_r($RS);

        $arr[] = array("id"=>$RS["id"], "com_ctlg_name"=>$RS["com_ctlg_name"], "com_ctlg_adrs"=>$RS["com_ctlg_adrs"],  "com_ctlg_img_adrs"=>$RS["com_ctlg_img_adrs"],"com_ctlg_img"=>$RS["com_ctlg_img"], "id_com"=>$RS["id_com"]);
//    echo '<br>'.'=w= ';print_r($arr);
        $i++;}
    return $arr;
}
...
function insert_update_ctlg($manage_site,$la,$com_ctlg_name,$com_ctlg_adrs,$com_ctlg_img_adrs,$com_ctlg_img,$edit_id,$coms_conect,$type=0){
    $query11="SELECT id from new_company_catalog where id_com='$edit_id' AND com_ctlg_name='$com_ctlg_name' AND  la='$la' and site='$manage_site' ";
//    if($type==1)
//        echo $query11.'<br>';
    $result11 = $coms_conect->query($query11);
    $row11 = mysqli_num_rows($result11);
//    print_r($row11);
    if ($row11> 0) {
        $row12 = $result11->fetch_assoc();
        $id=$row12['id'];
        $query="update new_company_catalog set com_ctlg_img_adrs='$com_ctlg_img_adrs', com_ctlg_name='$com_ctlg_name',com_ctlg_adrs='$com_ctlg_adrs',com_ctlg_img='$com_ctlg_img' where id='$id' AND id_com='$edit_id'  and la='$la'  and site='$manage_site'  ";
        //if($name=='google_code_analiz')
        if($type==1)
            echo $query;
        $coms_conect->query($query);
    }else{
        $query="insert into new_company_catalog(site,la,com_ctlg_name,com_ctlg_adrs,com_ctlg_img_adrs,com_ctlg_img,id_com)values('$manage_site','$la','$com_ctlg_name','$com_ctlg_adrs','$com_ctlg_img_adrs','$com_ctlg_img','$edit_id')";
        if($type==1)
            echo '<br>'.$query;
        $coms_conect->query($query);
...
//=====start resize pic setting

function get_PSR_result($la,$modual_type,$coms_conect){
    $query="select * from new_setting_pic_resize where  modual_type='$modual_type' and la='$la' ";
//    echo '<br>'.$query.'<br>';
    $result = $coms_conect->query($query);
//    echo '<br>';print_r($result);
    $i=0;
...
//    echo '<br>'.'=w= ';print_r($RS);
        ...
        $arr[] = array("id"=>$RS["id"], "width"=>$RS["width"], "height"=>$RS["height"],  "quality"=>$RS["quality"],"address_link_save"=>$RS["address_link_save"], "modual_type"=>$RS["modual_type"]);
//    echo '<br>'.'=w= ';print_r($arr);
        $i++;}
    return $arr;
}
...
function insert_update_PSR($id_pic,$manage_site,$la,$width_pic,$height_pic,$quality_pic,$address_link_pic,$modual_type,$coms_conect,$type=0){
    $query11="SELECT id from new_setting_pic_resize where id='$id_pic' AND modual_type='$modual_type'  AND  la='$la' and site='$manage_site' ";
    if($type==1)
        echo $query11.'<br>';
    $result11 = $coms_conect->query($query11);
    $row11 = mysqli_num_rows($result11);
//    print_r($row11);
    if ($row11> 0) {
        $row12 = $result11->fetch_assoc();
        $id=$row12['id'];
        $query="update new_setting_pic_resize set address_link_save='$address_link_pic', width='$width_pic',height='$height_pic',quality='$quality_pic' where id='$id'  AND modual_type='$modual_type'and la='$la'  and site='$manage_site'  ";
        //if($name=='google_code_analiz')
        if($type==1)
            echo $query;
        $coms_conect->query($query);
    }else{
        $query="insert into new_setting_pic_resize(site,la,address_link_save,width,height,quality,modual_type)values('$manage_site','$la','$address_link_pic','$width_pic','$height_pic','$quality_pic','$modual_type')";
        if($type==1)
            echo '<br>'.$query;
        $coms_conect->query($query);
...
//========//=====end resize pic setting
//======== =====



function show_madules_cat1($parentID,$site_id,$la,$type,$coms_conect,$modul_name='news') {
    $sql = "SELECT * FROM new_company_cat_brand WHERE parent_id='$parentID' and type='$type'  and la='$la' ORDER BY rang";
    //echo $sql;
    $result = $coms_conect->query($sql);
    if ($result->num_rows > 0) {
        echo "\n";
...
function show_madules_cat2($parentID,$site_id,$la,$type,$coms_conect,$modul_name='news') {
    $sql = "SELECT * FROM new_company_cat_type WHERE parent_id='$parentID' and type='$type'  and la='$la' ORDER BY rang";
    //echo $sql;
    $result = $coms_conect->query($sql);
    if ($result->num_rows > 0) {
        echo "\n";
        ...
        while($row = $result->fetch_assoc()) {
            ...
            echo '</div></div>';
            show_madules_cat($row['id'],$site_id,$la,$type,$coms_conect,$modul_name='company');
