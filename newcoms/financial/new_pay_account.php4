		...
		<ul class="nav nav-tabs">
			<li class="pull-right" >
				<button type="button" class="navbar-toggle btn-primary"  data-toggle="collapse" data-target="#bs-example-navbar-collapse-1">
					...
					<span data-toggle="tab" href="#add_list_money" title="افزودن حساب"><i class="ace-icon fa fa-plus bigger-110"></i></span>
				</button>
				...
				<form class="form-horizontal" action="" method="post" name="add_weather" id="add_weather" enctype="multipart/form-data">
					<div id="id-message-new-navbar" class="message-navbar clearfix">
						<div class="message-bar">
							<h2 style="color: #2a8bcb;">افزودن حساب بانکی / ویرایش</h2>
						</div>
						...
						<div class="container"> 
							<div class="col-md-6">
								<div class="form-group">
									<label class="col-sm-3 control-label">عنوان حساب</label>
								...
								<div class="form-group">
									<label class="col-sm-3 control-label" style="padding-right: 0px;">شماره حساب / کارت</label>
									<div class="form-group col-sm-9">
											<input type="text" name="parametr2" id="parametr2" class="form-control allownumericwithoutdecimal" >
									</div>
								</div>
							
								<div class="form-group">
									<label class="col-sm-3 control-label">نام صاحب حساب</label>
									<div class="form-group col-sm-9">
							...
							<div class="col-md-6">
								<div class="col-md-11">
									<div class="alert alert-warning">
										  نکته: حساب های بانکی که در اینجا معرفی می شوند به منظور اطلاع رسانی و ثبت فیش مورد استفاده قرار می گیرد.
									</div>
								</div>
							</div>
						</div>
