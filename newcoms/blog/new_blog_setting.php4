...
#####پیش فرض ناوبری	 
	$blog_nav_picture=injection_replace_pic($_POST["blog_nav_picture"]);
	$query11="SELECT id from new_default_navbar where name='blog_nav_picture' and la='$la' and site='$site'";
	//echo $query11.'<br>';
	$result11 = $coms_conect->query($query11);
	$row11 = mysqli_num_rows($result11);
	if ($row11> 0) {
	   $query="update new_default_navbar set address='$blog_nav_picture' where name='blog_nav_picture'  and la='$la'  and site='$site'"; 
	   $coms_conect->query($query);
	}else{
     	$query="insert into new_default_navbar(site,address,la,name)values('$site','$blog_nav_picture','$la','blog_nav_picture')";
     	$coms_conect->query($query);
	}
...
####صفحه اصلي
	$blog_have_ads=injection_replace_pic($_POST["blog_have_ads"]);
	if($blog_have_ads!=1) $blog_have_ads=0;
	insert_ads_templdate($site,$la,$blog_have_ads,'blog_have_ads',$coms_conect);
 	$query1="delete from new_tem_setting where name='blog_have_ads'"; 
	...
	for($i=1;$i<=$ads_count;$i++){ 
		...
		insert_news_templdate($site,$header_pic,$la,'',$title_ads,$header_link,'',"blog_have_ads",'',$coms_conect);
	} 
####فایل نمایش
	$blog_show_have_ads=injection_replace_pic($_POST["blog_show_have_ads"]);
	if($blog_show_have_ads!=1) $blog_show_have_ads=0;
	insert_ads_templdate($site,$la,$blog_show_have_ads,'blog_show_have_ads',$coms_conect);
 	$query1="delete from new_tem_setting where name='blog_show_have_ads'"; 
	$coms_conect->query($query1);
	for($i=1;$i<=$ads_show_count;$i++){ 
		...
		insert_news_templdate($site,$header_show_pic,$la,'',$title_show_ads,$header_show_link,'',"blog_show_have_ads",'',$coms_conect);
	}	
#######دسته بندي
	$blog_cat_have_ads=injection_replace_pic($_POST["blog_cat_have_ads"]);
	if($blog_cat_have_ads!=1) $blog_cat_have_ads=0;
	insert_ads_templdate($site,$la,$blog_cat_have_ads,'blog_cat_have_ads',$coms_conect);
	$query1="delete from new_tem_setting where name='blog_cat_have_ads'"; 
	$coms_conect->query($query1);
	for($i=1;$i<=$ads_cat_count;$i++){	
		...
		insert_news_templdate($site,$image_cat_ads,$la,'',$title_cat_ads,$link_cat_ads,'',"blog_cat_have_ads",'',$coms_conect);
	}

######جستجو	
	$blog_sesrch_have_ads=injection_replace_pic($_POST["blog_sesrch_have_ads"]);
	if($blog_sesrch_have_ads!=1) $blog_sesrch_have_ads=0;
	insert_ads_templdate($site,$la,$blog_sesrch_have_ads,'blog_sesrch_have_ads',$coms_conect);
	$query1="delete from new_tem_setting where name='blog_sesrch_have_ads'"; 
	$coms_conect->query($query1);
	for($i=1;$i<=$ads_search_count;$i++){ 
		...
		insert_news_templdate($site,$image_search_ads,$la,'',$title_search_ads,$link_search_ads,'',"blog_sesrch_have_ads",'',$coms_conect);
	}
}?>
...
<div class="tabbable">
	...
	<div class="secfhead">
<!-- #section:blog/blog_setting.head -->
<div class="sectitle">
<div class="icon"><span class="flaticon-file23" style=""></span></div>
<div class="title"><p class="titr">تنظيمات بلاگ</p><p class="lead">توضيحات اين بخش</p></div>
</div>
<!-- /section:blog/blog_setting.head -->
    ...
    <div class="">
		...
		<hr>
		 <div class="form-group col-md-12">
			<!-- #section:blog/blog_setting.default -->
			 <?$blog_nav_picture=get_result("select address from new_default_navbar where name='blog_nav_picture'  and la='$la' and site='$site'",$coms_conect);?>
			<label class="col-md-3 control-label" for="family">تصویر پیش فرض ناوبری</label>
			<div class="form-group col-md-9">
				<div class="col-md-6 input-group">
				<input type="text" style="direction: ltr;" class="col-md-6 form-control" data-toggle="popover"   value="<?=$blog_nav_picture?>"  id="blog_nav_picture" name="blog_nav_picture">
				<span class="input-group-btn"><a href="/filemanager/dialog.php?type=1&amp;field_id=blog_nav_picture" class="btn iframe-btn" type="button" >انتخاب</a></span>
				</div>
			</div>
			<!-- /section:blog/blog_setting.default -->
		 </div>
            ...
            <div class="col-lg-3 col-md-3 col-sm-3 col-xs-3 bhoechie-tab-menu">
              <div class="list-group">
                <a href="#" class="list-group-item active text-center">
                  تنظيمات بلاگ صفحه لیست 
                </a>
                <a href="#" class="list-group-item  text-center">
                   تنظيمات بلاگ صفحه نمایش
                </a> 
                <a href="#" class="list-group-item  text-center">
                   تنظيمات بلاگ صفحه دسته بندي
                </a> 
                <a href="#" class="list-group-item  text-center">
                   تنظيمات بلاگ صفحه دسته جستجو
                </a> 
              </div>
            </div>
...
<!---------------------new_modual_tem_setting-------------تماس با ما هدر------------>
			   ...
			   <!-- #section:blog/blog_setting.list -->
                    <center>
					<div class="form-group">
							<label class="col-md-3 control-label" for="family">نمايش تبليغات در صفحه اصلي</label> 
						<div class="form-group col-md-9">
							<div class="col-md-12 input-group">	
								<?$blog_have_ads=get_modual_setting_result($site,$la,'blog_have_ads',$coms_conect);?>
								<input type="checkbox" value="1" <?if($blog_have_ads==1) echo 'checked';?>   class="form-control" name="blog_have_ads" style="direction: ltr;float: right;width: 16px;margin-top: 0px;">
							</div>					
						</div>
					</div>
					<hr>
					<?$query="select title,link,pic_adress from new_tem_setting where name='blog_have_ads'  and la='$la' and site='$site'"; 
						$i=1;
...
<!---------------------فایل نمایش------------>
			   ...
			   <!-- #section:blog/blog_setting.view -->
                    <center>
					<div class="form-group">
							<label class="col-md-3 control-label" for="family">نمايش تبليغات در صفحه اصلي</label> 
						<div class="form-group col-md-9">
							<div class="col-md-12 input-group">	
								<?$blog_show_have_ads=get_modual_setting_result($site,$la,'blog_show_have_ads',$coms_conect);?>
								<input type="checkbox" value="1" <?if($blog_show_have_ads==1) echo 'checked';?>   class="form-control" name="blog_show_have_ads" style="direction: ltr;float: right;width: 16px;margin-top: 0px;">
							</div>					
						</div>
					</div>
					<hr>
					<?$query9="select title,link,pic_adress from new_tem_setting where name='blog_show_have_ads'  and la='$la' and site='$site'"; 
						$i=1;
...
<!----------------------------------صفحه دسته بندي------------------------>
			   <div class="bhoechie-tab-content ">
			   <!-- #section:blog/blog_setting.cate -->
                    <center>
					<div class="form-group">
							<label class="col-md-3 control-label" for="family">نمايش تبليغات در صفحه دسته بندي</label> 
						<div class="form-group col-md-9">
							<div class="col-md-12 input-group">	
								<?$blog_cat_have_ads=get_modual_setting_result($site,$la,'blog_cat_have_ads',$coms_conect);?>
								<input type="checkbox" value="1" <?if($blog_cat_have_ads==1) echo 'checked';?>   class="form-control" name="blog_cat_have_ads" style="direction: ltr;float: right;width: 16px;margin-top: 0px;">
							</div>					
						</div>
					</div>
										<hr>
					<?$query11="select title,link,pic_adress from new_tem_setting where name='blog_cat_have_ads'  and la='$la' and site='$site'"; 
						//echo $query.'<br>';
						$i=1;
						$result11 = $coms_conect->query($query11);
...
<!----------------------------------صفحه دسته بندي------------------------>
			   <div class="bhoechie-tab-content ">
			   <!-- #section:blog/blog_setting.search -->
                    <center>
					<div class="form-group">
							<label class="col-md-3 control-label" for="family">نمايش تبليغات در صفحه جستجو</label> 
						<div class="form-group col-md-9">
							<div class="col-md-12 input-group">	
								<?$blog_sesrch_have_ads=get_modual_setting_result($site,$la,'blog_sesrch_have_ads',$coms_conect);?>
								<input type="checkbox" value="1" <?if($blog_sesrch_have_ads==1) echo 'checked';?>   class="form-control" name="blog_sesrch_have_ads" style="direction: ltr;float: right;width: 16px;margin-top: 0px;">
							</div>					
						</div>
					</div>
										<hr>
					<?$query11="select title,link,pic_adress from new_tem_setting where name='blog_sesrch_have_ads'  and la='$la' and site='$site'"; 
						$i=1;
						$result11 = $coms_conect->query($query11);
						    while($RS11 = $result11->fetch_assoc()) {
							?>
