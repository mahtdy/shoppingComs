...
//=========end=== search word in text =======

//========= resize image =======
function resize_imagejpg($src_file, $w, $h,$dst_file,$quality) {
    if($quality=='')
        $quality=70;
    $ww=$dst_file;
    ...
    imagejpeg($dst,$dst_file,$quality);
    return    $dst_file;
}
...
function insert_update_PSR($manage_site,$la,$width_pic,$height_pic,$quality_pic,$address_link_pic,$modual_type,$coms_conect,$type=0){
    $query11="SELECT id from new_setting_pic_resize where modual_type='$modual_type' AND width='$width_pic' AND  la='$la' and site='$manage_site' ";
    if($type==1)
        echo $query11.'<br>';
    $result11 = $coms_conect->query($query11);
    $row11 = mysqli_num_rows($result11);
