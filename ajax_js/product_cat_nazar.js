	...
	$("#btn_ok").val($("#check_value").val());
		...
		$("#btn_ok").click(function () {
			$.ajax({
				...
				data:"action=nes_tik_cat_nazar_del&id="+$(this).val(),
				success: function(result){
					//alert(result);
                    window.location.href = "newcoms.php?yep=new_product_cat_nazar&catid=" + $("#catid_val").val();
				}
			});
		});
	...
	$(".edit_menu").click(function () {
			var a=$(this).attr('id');
				$.ajax({
					type:'POST',
					url:'New_ajax_product.php',
					data:"action=edit_page_cat_nazar&id="+a,
					success: function(result){
						// console.log(result);
						$('#name_cat').val(result);
		...
		// alert('a='+a+'b='+b);
			$.ajax({
				type:'POST',
				url:'New_ajax_product.php',
				data:"action=edit_cat_nazar&value="+b+"&id="+a,
				success: function(result){
