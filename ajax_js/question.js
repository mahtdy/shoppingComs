	...
	$("#btn_ok").val($("#check_value").val());
		...
		b=0;
			$.ajax({
				type:'POST',
				url:'New_ajax.php',
				data:"action=edit_new_question&value="+b+"&id="+a,
	...
	$(function () {
		...
		$("#btn_ok").click(function () {
			$.ajax({
				type:'POST',
				url:'New_ajax.php',
				data:"action=del_new_question&id="+$(this).val(),
				success: function(result){
					//window.location='newcoms.php?yep=new_question'	
				}
			});
		});	
		...
		$(".show_details").click(function () {
			$.ajax({
				type:'POST',
				url:'New_ajax.php',
				data:"action=show_question_details&id="+$(this).attr('id'),
				success: function(result){
					//alert(result);
