<?view_module(1,$coms_conect);?>        <!-- Start breadcrumb -->
        ...
        <div class="container">
            <main> 
			 <?$query23="select id,left_block,right_block,center from new_blocks_sorts where type='m'  and tem_name='$tem_name' and file_name=3 and pages_id=6";
			//echo $query23;
									...
									<script>
									 $(document).ready(function () {
												...
												$.ajax({
													...
													data:"action=download_type_change_cat&id="+$("#download_type").val()+"&value=<?=$madual_cat_id?>",
