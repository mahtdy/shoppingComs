  ...
  <div class="row profile">
					<div class="clearfix tab-header">
						...
						<ul class="nav nav-tabs pull-left">
							<li data-filename="profile" class="<?php if($url_temp[3]!="ads"&&!isset($_POST['deposit_price'])&&!isset($_POST['credit_price'])&&!isset($_POST['ticket_subject'])&&!isset($madual_main_file)) echo 'active'?>"><!-- TAB 1 -->
								<a href="#profile_li" data-toggle="tab"><i class="fa fa-eye text-muted"></i> <?=$view_profile?></a>
							</li>
							<li data-filename="acount" class=""><!-- TAB 2 -->
								<a href="#acount_li" data-toggle="tab"><i class="fa fa-cogs text-muted"></i> <?=$view_account?></a>
							</li>
							<li data-filename="ads" class="<?if($url_temp[3]=="ads")echo 'active';?>"><!-- TAB 2 -->
								<a href="#ads_li" data-toggle="tab"><i class="fa fa-cogs text-muted"></i> <?=$view_ads?></a>
							</li>
							<li data-filename="financial" class="<?php if(isset($_POST['credit_price'])||isset($_POST['deposit_price'])) echo 'active'?>"><!-- TAB 2 -->
								<a href="#financial_li" data-toggle="tab"><i class="fa fa-cogs text-muted"></i> <?=$view_accounting?></a>
							</li>
							<li data-filename="request" class="<?php if(isset($_POST['ticket_subject'])||isset($madual_main_file)) echo 'active'?>"><!-- TAB 2 -->
								<a href="#request_li" data-toggle="tab"><i class="fa fa-cogs text-muted"></i> <?=$view_request?></a>
							</li>
						</ul>
						<!-- /tabs nav -->
					...
					<div class="clearfix tab-body profile-tabs">
						...
						<div class="tab-content transparent">
							<div id="profile_li" class="tab-pane <?php if($url_temp[3]!="ads"&&!isset($_POST['deposit_price'])&&!isset($_POST['credit_price'])&&!isset($madual_main_file)) echo 'active'?>">
								<div class="row  ">
									<div class="col-lg-3 col-md-4">
										...
										<ul class="side-nav list-group margin-bottom30" style="direction:rtl;">
											<li class="list-group-item <?if($url_temp[1]=='profile'&&count($url_temp)==3)echo 'active';?>"><a href="#a" data-toggle="tab"><i class="fa fa-home"></i> <?=$view_profile?></a></li>
											
											<li class="list-group-item " style="padding: 0;    background: transparent;
											border: rgba(0,0,0,0.1) 1px solid;
											border-left: 0;
											border-right: 0;"><div class="m_noty">25</div>
											
											 <a href="#p" style="color: #fff !important;    background-color: rgba(0,0,0,0.5);    padding: 7px 10px;display: block;text-decoration: none;"  data-toggle="tab"><i class="fa fa-comments"></i> <?=$view_inbox?>
											<li class="list-group-item"><a href="#h" data-toggle="tab"><i class="fa fa-edit"></i> <?=$view_favorite_me?></a></li>
											<li class="list-group-item"><a href="#z" data-toggle="tab"><i class="fa fa-users"></i> <?=$view_friends?></a></li>
										</ul>
									</div>
									<div class="col-lg-9 col-md-8" style="direction:rtl;">	
									<div class="tabbable">					
										<div class="tab-content transparent">
											<div class="tab-pane <?if($url_temp[1]=='profile'&&count($url_temp)==3)echo 'active';?>" id="a">
												<? include "new_dynamics/default/profile/profile.php4" ?>
											</div> 
											<div class="tab-pane " id="z"></div>
											<div class="tab-pane <?if($url_temp[1]=='profile'&&$url_temp[3]=='pm') echo 'active';?>" id="p">
												<? include "new_dynamics/default/profile/resive_pm.php4" ?>
											</div>	
							...
							<div id="acount_li" class="tab-pane" style="  direction: rtl;">
								<div class="row">
									<div class="col-lg-3 col-md-4">
										<div class="clearfix tab-header">
											<ul class="side-nav list-group margin-bottom30">
												<li class="list-group-item active"><a href="#tab-s1" data-toggle="tab"><i class="fa fa-cog"></i> <?=$view_personal_information?></a></li>
												<li class="list-group-item"><a href="#tab-s2" data-toggle="tab"><i class="fa fa-eye"></i> <?=$view_change_avatar?></a></li>
												<li class="list-group-item"><a href="#tab-s3" data-toggle="tab"><i class="fa fa-lock"></i> <?=$view_change_password?></a></li>
												<li class="list-group-item"><a href="#tab-s4" data-toggle="tab"><i class="fa fa-cogs"></i> <?=$view_personal_setting?></a></li>
											</ul>
										</div>
									</div>
									<div class="col-lg-9 col-md-8" style="direction:rtl;">
										<div class="tab-content transparent">
											<div id="tab-s1" class="tab-pane active">
												<form role="form" action="#" method="post" enctype="multipart/form-data">
													...
													<div class="form-group">
														<label class="control-label"><?=$view_mobile?></label>
													...
													<div class="form-group">
														<label class="control-label"><?=$view_favorites?></label>
														<input type="text" value="<?=$favorites?>" name="favorites"  class="form-control">
													</div>
													<div class="form-group">
														<label class="control-label"><?=$view_job?></label>
												...
												<div class="form-group">
													<div class="row">
														...
														<div class="col-lg-7 col-md-7 col-sm-12">
															...
															<a href="#" id="del_avatar" class="btn btn-danger btn-xs "><i class="fa fa-times"></i> <?=$view_delete_avatar?></a>
														</div>
													</div>
												</div>
											</div>
											<div id="tab-s3" class="tab-pane">
													...
													<div class="form-group">
														<label class="control-label"><?=$view_repeat_new_password?></label>
											...
											<div id="tab-s4" class="tab-pane">
												<div class="sky-form">
													<table class="table table-bordered table-striped">
														<tbody>
															<tr>
																<td><?=$view_active_login2?></td>
																<td>
																	<div class="inline-group">
																		<label class="radio">
																			<input type="radio" value='1' name="sms_login" <?if($sms_login==1) echo 'checked'?>><i></i> <?=$view_yes?>
																		</label>

																		<label class="radio">
																			<input type="radio" value='0' name="sms_login" <?if($sms_login==0) echo 'checked'?> ><i></i> <?=$view_no?>
																		</label>
																	</div>
																</td>
															</tr>
															<tr>
																...
																<td>
																	<label class="checkbox nomargin">
																		<input type="checkbox" name="checkbox" checked=""><i></i> <?=$view_yes?>
																	</label>
																</td>
															</tr>
															<tr>
													...
													<div class="form-group">
														<label class="control-label"><?=$view_security_question?></label>
											...
											<div class="margiv-top10">
												<button   type='submit' value='' class="btn btn-primary"><?=$view_save_changing?></button>
												<a href="<?="/profile/$madual_lang"?>" class="btn btn-default"><?=$view_cancel?> </a>
											</div>
										</div>
									</div>
								</div>
							...
							<div id="ads_li" class="tab-pane <?if($url_temp[3]=="ads")echo 'active';?>">
								<div class="row">
									<div class="col-lg-3 col-md-4">
										...
										<ul class="side-nav list-group margin-bottom30" style="direction:rtl;">
											<li class="list-group-item <?php if(isset($madual_main_file)&&$madual_main_file=='all_ads') echo 'active'?>"><a data-status="0" href="#all_ads" class="show_ads_li" data-toggle="tab"><i class="fa fa-home"></i> <?=$view_all_ads?></a></li>
											<li class="list-group-item"><a data-status="1" href="#ads_now_show" class="show_ads_li" data-toggle="tab"><i class="fa fa-comments"></i> <?=$view_now_showing?></a></li>
											<li class="list-group-item"><a data-status="2" href="#ads_approve" class="show_ads_li" data-toggle="tab"><i class="fa fa-edit"></i> <?=$view_vertificates?></a></li>
											<li class="list-group-item <?if($url_temp[3]=="ads"&&$url_temp[4]=="edit")echo 'active';?>"><a href="#ads_send" data-toggle="tab"><i class="fa fa-users"></i><?=$view_send_ads?></a></li>
										</ul>
									</div>
									<div class="col-lg-9 col-md-8" style="direction:rtl;">						
										<div class="tab-content transparent">
											<div class="tab-pane <?php if(isset($madual_main_file)&&$madual_main_file=='all_ads') echo 'active'?>" id="all_ads">
											...
											<div class="tab-pane <?if($url_temp[3]=="ads"&&$url_temp[4]=="edit")echo 'active';?>" id="ads_send">
												<? include "new_dynamics/default/profile/ads_send.php4" ?>
											</div>
							...
							<div id="financial_li" class="tab-pane <?php if(isset($_POST['credit_price'])||isset($_POST['deposit_price'])) echo 'active'?>">
								<div class="row">
									<div class="col-lg-3 col-md-4">
										<figure class="default-gradient bg-silver text-center margin-bottom8">
										</figure>
										<ul class="side-nav list-group margin-bottom30" style="direction:rtl;">
											<li class="list-group-item <?php if(!isset($_POST['deposit_price'])&&!isset($_POST['credit_price'])) echo 'active'?>"><a href="#financial_transactions" data-toggle="tab"><i class="fa fa-home"></i> <?=$view_financial_list?></a></li>
											<li class="list-group-item"><a href="#financial_payment" data-toggle="tab"><i class="fa fa-comments"></i><?=$view_list_internet_payments?></a></li>
											<li class="list-group-item"><a href="#financial_online_charge" data-toggle="tab"><i class="fa fa-edit"></i> <?=$view_online_charging_account?></a></li>
											<li class="list-group-item <?php if(isset($_POST['deposit_price']) ||isset($_POST['credit_price'])) echo 'active'?>"><a href="#financial_register_receipt" data-toggle="tab"><i class="fa fa-users"></i><?=$view_receipt_register?></a></li>
											<li class="list-group-item  "><a href="#financial_receipt_list" data-toggle="tab"><i class="fa fa-users"></i><?=$view_receipt_bank_list?></a></li>
										</ul>
									</div>
									<div class="col-lg-9 col-md-8" style="direction:rtl;">						
										<div class="tab-content transparent">
											<div class="tab-pane <?php if(!isset($_POST['deposit_price'])&&!isset($_POST['credit_price'])) echo 'active'?>" id="financial_transactions">
												<? include "new_dynamics/default/profile/financial_transactions.php4" ?>
											</div>
											<div class="tab-pane" id="financial_payment">
												<? include "new_dynamics/default/profile/financial_payment.php4" ?>
											</div>
											<div class="tab-pane" id="financial_online_charge">
												<? include "new_dynamics/default/profile/financial_online_charge.php4" ?>
											</div>	
											<div class="tab-pane <?php if(isset($_POST['deposit_price']) ||isset($_POST['credit_price'])) echo 'active'?>" id="financial_register_receipt">
												<? include "new_dynamics/default/profile/financial_register_receipt.php4" ?>
											</div>
											<div class="tab-pane " id="financial_receipt_list">
												<? include "new_dynamics/default/profile/financial_receipt_list.php4" ?>
											</div>
										</div>
									</div>
								</div>
							</div>
							<div id="request_li" class="tab-pane <?php if(isset($_POST['ticket_subject'])||isset($madual_main_file)) echo 'active'?>">
								<div class="row">
									<div class="col-lg-3 col-md-4">
										<figure class="default-gradient bg-silver text-center margin-bottom8">
										</figure>
										<ul class="side-nav list-group margin-bottom30" style="direction:rtl;">
											<li class="list-group-item <?php if(isset($_POST['ticket_subject'])) echo 'active'?>"><a href="#new_request" data-toggle="tab"><i class="fa fa-home"></i> <?=$view_new_request_send?></a></li>
											<li class="list-group-item <?php if(isset($madual_main_file)&&$madual_main_file=='new_show_ticket') echo 'active'?>"><a  href="#show_request" data-toggle="tab"><i class="fa fa-comments"></i><?=$view_view_request?></a></li>
											<li class="list-group-item  <?php if(isset($madual_main_file)&&$madual_main_file=='new_showall_ticket') echo 'active'?>"><a data-status="0" class="show_request_li" href="#show_all_request" data-toggle="tab"><i class="fa fa-comments"></i><?=$view_all_requests?></a></li>
											<li class="list-group-item  "><a data-status="1" class="show_request_li" href="#open_request" data-toggle="tab"><i class="fa fa-comments"></i><?=$view_open_requests?></a></li>
											<li class="list-group-item  "><a data-status="2" class="show_request_li" href="#check_request" data-toggle="tab"><i class="fa fa-edit"></i><?=$view_pending_requests?></a></li>
											<li class="list-group-item "><a data-status="3" class="show_request_li" href="#close_request" data-toggle="tab"><i class="fa fa-users"></i><?=$view_closed_requests?></a></li>
										</ul>
									</div>
									<div class="col-lg-9 col-md-8" style="direction:rtl;">						
										<div class="tab-content transparent">
										
											<div class="tab-pane <?php if(isset($_POST['ticket_subject'])) echo 'active'?>" id="new_request">
												<? include "new_dynamics/default/profile/new_request.php4" ?>
											</div>
											<div class="tab-pane <?php if(isset($madual_main_file)&&$madual_main_file=='new_show_ticket') echo 'active'?>" id="show_request">
												<? include "new_dynamics/default/profile/new_show_ticket.php4" ?>
											</div>
											<div class="tab-pane <?php if(isset($madual_main_file)&&$madual_main_file=='new_showall_ticket') echo 'active'?>" id="show_all_request">
